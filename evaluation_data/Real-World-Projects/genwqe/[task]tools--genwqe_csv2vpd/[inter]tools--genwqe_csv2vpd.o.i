...
static char input_fn[512];
static char output_fn[512];
...
static BOOL convert_csv(void)
{
 ...
 uint8_t *buffer = 
# 195 "genwqe_csv2vpd.c" 3 4
                  ((void *)0)
# 195 "genwqe_csv2vpd.c"
                      ;

 ip = fopen(input_fn, "r");
 if (ip == 
# 198 "genwqe_csv2vpd.c" 3 4
          ((void *)0) 
# 198 "genwqe_csv2vpd.c"
               ) {
 ...
 if (op == 
# 204 "genwqe_csv2vpd.c" 3 4
          ((void *)0) 
# 204 "genwqe_csv2vpd.c"
               ) {
 ...
 while (fgets(line, 512, ip) != 
# 210 "genwqe_csv2vpd.c" 3 4
                                    ((void *)0) 
# 210 "genwqe_csv2vpd.c"
                                         ) {
  int field_num = 0;
  int num_fields;
  int line_len;
  ...
  if (line[0] != '0' || tolower(line[1]) != 'x') {
   if (verbose_flag)
    printf("\nSkipping Line (#%d) " "len: %d <%s>", line_nr, line_len, line)
    ...
    if (strlen(token) != 0) {
     ...
     case 6:
      if (0 == strncmp(crc_token,
       ...
       if (0 == crc32_seek) {
        if (verbose_flag)
         printf("Token (crc32): " "at offset %d <%s>\n", offset, token)
  ...
  if (!parse_error && ((num_fields == 3) || (num_fields == 2))) {
   if (verbose_flag)
    printf("Offset: <0x%04X>, Desc: <%s>, " "Value: <0x%02X>\n", offset, desc, value)

                              ;
   fseek(op, offset, 
# 321 "genwqe_csv2vpd.c" 3 4
                    0
# 321 "genwqe_csv2vpd.c"
                            );
   data = (uint8_t)value;;
 ...
 if (verbose_flag)
  printf("Close In <%s> Out <%s> Size %d\n", input_fn, output_fn, last_byte)
                             ;
 fclose(op);
 fclose(ip);
 ...
 if ((TRUE == add_crc) && (0 != crc32_seek)) {
  ...
  if (op == 
# 338 "genwqe_csv2vpd.c" 3 4
           ((void *)0) 
# 338 "genwqe_csv2vpd.c"
                ) {
  ...
  if (
# 343 "genwqe_csv2vpd.c" 3 4
     ((void *)0) 
# 343 "genwqe_csv2vpd.c"
          == buffer) {
  ...
  if (nrw == last_byte) {
   ...
   printf("%ld %d %s\n", (unsigned long)crc32, last_byte, output_fn)
                              ;
   ...
   fseek(op, crc32_seek, 
# 357 "genwqe_csv2vpd.c" 3 4
                        0
# 357 "genwqe_csv2vpd.c"
                                );
...
static char *next_arg(void)
{
 ...
 return (
# 387 "genwqe_csv2vpd.c" 3 4
        ((void *)0)
# 387 "genwqe_csv2vpd.c"
            );
}
...
static char *get_next_arg(void)
{
 if (arg_index < arg_count)
  return (arg_values[arg_index++]);
 return (
# 394 "genwqe_csv2vpd.c" 3 4
        ((void *)0)
# 394 "genwqe_csv2vpd.c"
            );
}
