...
# 444 "/usr/local/include/zconf.h" 3
...
# 445 "/usr/local/include/zconf.h" 2 3
...
# 68 "zpipe.c"
           "ret != Z_STREAM_ERROR"
# 68 "zpipe.c" 3 4
           , "zpipe.c", 68, __PRETTY_FUNCTION__))
# 68 "zpipe.c"
                                        ;
...
# 75 "zpipe.c"
       "strm.avail_in == 0"
# 75 "zpipe.c" 3 4
       , "zpipe.c", 75, __PRETTY_FUNCTION__))
# 75 "zpipe.c"
                                 ;
...
# 79 "zpipe.c"
   "ret == Z_STREAM_END"
# 79 "zpipe.c" 3 4
   , "zpipe.c", 79, __PRETTY_FUNCTION__))
# 79 "zpipe.c"
                              ;
...
# 126 "zpipe.c"
           "ret != Z_STREAM_ERROR"
# 126 "zpipe.c" 3 4
           , "zpipe.c", 126, __PRETTY_FUNCTION__))
# 126 "zpipe.c"
                                        ;
            switch (ret) {
            case 
