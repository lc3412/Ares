        ...
        int width, off_t offset, uint64_t *val)
{
 ...
 fd = open(res, 
# 97 "genwqe_peek.c" 3 4
               02
# 97 "genwqe_peek.c"
                     );
 if (fd < 0) {
  fprintf(
# 99 "genwqe_peek.c" 3 4
         stderr
# 99 "genwqe_peek.c"
               , "err: Can not open %s %s\n",
   res, strerror(
# 100 "genwqe_peek.c" 3 4
                (*__errno_location ())
# 100 "genwqe_peek.c"
                     ));
  exit(
# 101 "genwqe_peek.c" 3 4
      1
# 101 "genwqe_peek.c"
                  );
 }
...
# 106 "genwqe_peek.c" 3 4
       0x01
# 106 "genwqe_peek.c"
                 , fd, 0);
 if (memblk == 
# 107 "genwqe_peek.c" 3 4
              ((void *) -1)
# 107 "genwqe_peek.c"
                        ) {
  fprintf(
# 108 "genwqe_peek.c" 3 4
         stderr
# 108 "genwqe_peek.c"
               , "err: Can not mmap %s\n", res);
  exit(
# 109 "genwqe_peek.c" 3 4
      1
# 109 "genwqe_peek.c"
                  );
 }
...
# 221 "genwqe_peek.c"
  ...
  case 'e':
   equal = 1;
   equal_val = strtoull(optarg, 
# 225 "genwqe_peek.c" 3 4
                               ((void *)0)
# 225 "genwqe_peek.c"
                                   , 0);
   break;
  case 'n':
   not_equal = 1;
   not_equal_val = strtoull(optarg, 
# 229 "genwqe_peek.c" 3 4
                                   ((void *)0)
# 229 "genwqe_peek.c"
                                       , 0);
   break;
  case 'a':
   and_mask = strtoull(optarg, 
# 232 "genwqe_peek.c" 3 4
                              ((void *)0)
# 232 "genwqe_peek.c"
                                  , 0);
   break;
...
# 251 "genwqe_peek.c"
 ...
 if (optind + 1 != argc) {
  usage(argv[0]);
  exit(
# 257 "genwqe_peek.c" 3 4
      1
# 257 "genwqe_peek.c"
                  );
 }
 offs = strtoull(argv[optind], 
# 259 "genwqe_peek.c" 3 4
                              ((void *)0)
# 259 "genwqe_peek.c"
                                  , 0);
...
# 282 "genwqe_peek.c"
 ...
 if (card == 
# 287 "genwqe_peek.c" 3 4
            ((void *)0)
# 287 "genwqe_peek.c"
                ) {
  fprintf(
# 288 "genwqe_peek.c" 3 4
         stderr
# 288 "genwqe_peek.c"
...
# 291 "genwqe_peek.c"
 ...
 for (i = 0; i < count; i++) {
  ...
  if (rc != 0) {
   fprintf(
# 306 "genwqe_peek.c" 3 4
          stderr
# 306 "genwqe_peek.c"
                , "err: could not read [%08x] rc=%d\n",
    offs, rc);
   accel_close(card);
   exit(
# 309 "genwqe_peek.c" 3 4
       1
# 309 "genwqe_peek.c"
                   );
  }
  if ((equal) &&
   ...
   fprintf(
# 313 "genwqe_peek.c" 3 4
          stderr
# 313 "genwqe_peek.c"
                , "err: [%08x] %016llx != %016llx\n",
