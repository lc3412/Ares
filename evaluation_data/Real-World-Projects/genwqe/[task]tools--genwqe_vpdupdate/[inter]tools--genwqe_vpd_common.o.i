...
void genwqe_crc32_setup_lut(void)
{
 ...
 for (i = 0; i < ((sizeof((genwqe_crc32_lut))/sizeof((genwqe_crc32_lut)[0]))); i++) {
  crc = i << 24;
  for ( j = 0; j < 8; j++ ) {
   if (crc & 0x80000000)
...
# 95 "genwqe_vpd_common.c"

# 95 "genwqe_vpd_common.c" 3 4
_Bool 
# 95 "genwqe_vpd_common.c"
    bin_2_csv(FILE *op, int fs, uint8_t *buffer)
{
 ...
 while (fs) {
  ...
  if (0 != strcmp(label, vpd_ref_102[vpd_check_line].label)) {
   do { fprintf(
# 112 "genwqe_vpd_common.c" 3 4
  stderr
# 112 "genwqe_vpd_common.c"
  , "%s:%u: Error: " "Binary File Got: %s Expect: %s\n",
                                                  "genwqe_vpd_common.c"
# 112 "genwqe_vpd_common.c"
   ,
                                                  113
# 112 "genwqe_vpd_common.c"
   , label, vpd_ref_102[vpd_check_line].label); } while (0)
                                                   ;
   return 
# 114 "genwqe_vpd_common.c" 3 4
         0
# 114 "genwqe_vpd_common.c"
              ;
  }
  if (length != vpd_ref_102[vpd_check_line].length) {
   do { fprintf(
# 117 "genwqe_vpd_common.c" 3 4
  stderr
# 117 "genwqe_vpd_common.c"
  , "%s:%u: Error: " "Binary File Got: %d Expect: %d\n",
                                                    "genwqe_vpd_common.c"
# 117 "genwqe_vpd_common.c"
   ,
                                                    118
# 117 "genwqe_vpd_common.c"
   , length, vpd_ref_102[vpd_check_line].length); } while (0)
                                                     ;
   return 
# 119 "genwqe_vpd_common.c" 3 4
         0
# 119 "genwqe_vpd_common.c"
              ;
  }
  if (mode != *vpd_ref_102[vpd_check_line].mode) {
   do { fprintf(
# 122 "genwqe_vpd_common.c" 3 4
  stderr
# 122 "genwqe_vpd_common.c"
  , "%s:%u: Error: " "Binary File Got: %c Expect: %c\n",
                                                 "genwqe_vpd_common.c"
# 122 "genwqe_vpd_common.c"
   ,
                                                 123
# 122 "genwqe_vpd_common.c"
   , mode, *vpd_ref_102[vpd_check_line].mode); } while (0)
                                                  ;
   return 
# 124 "genwqe_vpd_common.c" 3 4
         0
# 124 "genwqe_vpd_common.c"
              ;
  }
  ...
  if ('A' == mode) {
   ...
   for(n = 0; n < length; n++) {
    if (
# 130 "genwqe_vpd_common.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 130 "genwqe_vpd_common.c"
       *buffer
# 130 "genwqe_vpd_common.c" 3 4
...
# 130 "genwqe_vpd_common.c"
  ...
  if ('X' == mode) {
   if(0 == vpd_check_line) {
    ...
    swap.ui32 = 
# 141 "genwqe_vpd_common.c" 3 4
               (__builtin_constant_p((__u32)((__u32)(__be32)(
# 141 "genwqe_vpd_common.c"
               swap.ui32
# 141 "genwqe_vpd_common.c" 3 4
...
# 141 "genwqe_vpd_common.c"
    ...
    if (swap.ui32 != 0x102) {
     do { fprintf(
# 143 "genwqe_vpd_common.c" 3 4
    stderr
# 143 "genwqe_vpd_common.c"
    , "%s:%u: Error: " "Wrong Version: %x Expect: %x\n",
                                  "genwqe_vpd_common.c"
# 143 "genwqe_vpd_common.c"
     ,
                                  144
# 143 "genwqe_vpd_common.c"
     , swap.ui32, 0x102); } while (0)
                                   ;
     return 
# 145 "genwqe_vpd_common.c" 3 4
           0
# 145 "genwqe_vpd_common.c"
                ;
    }
   }
   for(n = 0; n < length; n++)
...
# 156 "genwqe_vpd_common.c" 3 4
stdout
# 156 "genwqe_vpd_common.c"
, "Check for %d of %d tokens in bin file.\n", vpd_check_line, (int)(sizeof(vpd_ref_102)/sizeof(struct vpd_layout))); } while (0)
                                    ;
 if ((sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) != vpd_check_line) {
  do { fprintf(
# 159 "genwqe_vpd_common.c" 3 4
 stderr
# 159 "genwqe_vpd_common.c"
 , "%s:%u: Error: " "%d of %d tokens fond in input.\n",
                                          "genwqe_vpd_common.c"
# 159 "genwqe_vpd_common.c"
  ,
                                          160
# 159 "genwqe_vpd_common.c"
  , vpd_check_line, (int)(sizeof(vpd_ref_102)/sizeof(struct vpd_layout))); } while (0)
                                           ;
  return 
# 161 "genwqe_vpd_common.c" 3 4
        0
# 161 "genwqe_vpd_common.c"
             ;
 }
 return 
# 163 "genwqe_vpd_common.c" 3 4
       1
# 163 "genwqe_vpd_common.c"
           ;
}
# 178 "genwqe_vpd_common.c"

# 178 "genwqe_vpd_common.c" 3 4
_Bool 
# 178 "genwqe_vpd_common.c"
    csv_2_bin(FILE *ip,
        uint8_t *buffer,
...
# 191 "genwqe_vpd_common.c" 3 4
_Bool 
# 191 "genwqe_vpd_common.c"
     parse_error;
 
# 192 "genwqe_vpd_common.c" 3 4
_Bool 
# 192 "genwqe_vpd_common.c"
     get_crc_value = 
# 192 "genwqe_vpd_common.c" 3 4
                     0
# 192 "genwqe_vpd_common.c"
 ...
 while (
# 205 "genwqe_vpd_common.c" 3 4
       ((void *)0) 
# 205 "genwqe_vpd_common.c"
            != fgets(line, 512, ip)) {
  int field_num = 0;
  int num_fields;
  int line_len;
...
# 219 "genwqe_vpd_common.c" 3 4
 stdout
# 219 "genwqe_vpd_common.c"
 , "Line (#%d) %d: <%s>\n", line_nr, line_len, line); } while(0);
  field_num = 0;
  parse_error = 
# 221 "genwqe_vpd_common.c" 3 4
               0
# 221 "genwqe_vpd_common.c"
                    ;
    ...
    case 0:
     ...
     if (2 == n) {
      ...
      if (0 == strncmp(crc_token,
         token, 2))
       get_crc_value = 
# 235 "genwqe_vpd_common.c" 3 4
                      1
# 235 "genwqe_vpd_common.c"
                          ;
      if (0 != strcmp(&token[0], vpd_ref_102[vpd_check_line].label))
       parse_error = 
# 237 "genwqe_vpd_common.c" 3 4
                    1
# 237 "genwqe_vpd_common.c"
                        ;
     } else {
      i = line_len;
    ...
    case 1:
     parse_error = 
# 245 "genwqe_vpd_common.c" 3 4
                  1
# 245 "genwqe_vpd_common.c"
                      ;
     n = sscanf(&token[0], "%d", &data_len);
     if (1 == n) {
      if (data_len == vpd_ref_102[vpd_check_line].length) {
       data[2] = data_len;
       write_size = 2 + 1 + 1 + data_len;
       parse_error = 
# 251 "genwqe_vpd_common.c" 3 4
                    0
# 251 "genwqe_vpd_common.c"
                         ;
      }
     }
     break;
    case 2:
     parse_error = 
# 256 "genwqe_vpd_common.c" 3 4
                  1
# 256 "genwqe_vpd_common.c"
                      ;
     if (1 == strlen(&token[0])) {
      mode = token[0];
      if (0 == strcmp(&token[0], vpd_ref_102[vpd_check_line].mode))
       parse_error = 
# 260 "genwqe_vpd_common.c" 3 4
                    0
# 260 "genwqe_vpd_common.c"
                         ;
     }
     break;
    case 3:
     parse_error = 
# 264 "genwqe_vpd_common.c" 3 4
                  1
# 264 "genwqe_vpd_common.c"
                      ;
     data[3] = mode;
     n = strlen(&token[0]);
     if ('A' == mode) {
      if (n <= data_len) {
       ...
       parse_error = 
# 270 "genwqe_vpd_common.c" 3 4
                    0
# 270 "genwqe_vpd_common.c"
                         ;
      }
     } else if ('X' == mode) {
      if (n <= (2* data_len)) {
       ...
       parse_error = 
# 286 "genwqe_vpd_common.c" 3 4
                    0
# 286 "genwqe_vpd_common.c"
                         ;
       if (0 == vpd_check_line) {
        ...
        swap.ui32 = 
# 291 "genwqe_vpd_common.c" 3 4
                   (__builtin_constant_p((__u32)((__u32)(__be32)(
# 291 "genwqe_vpd_common.c"
                   swap.ui32
# 291 "genwqe_vpd_common.c" 3 4
                   ))) ? ((__u32)( (((__u32)((__u32)(__be32)(
# 291 "genwqe_vpd_common.c"
...
# 291 "genwqe_vpd_common.c"
        ...
        if (swap.ui32 != 0x102) {
         do { fprintf(
# 293 "genwqe_vpd_common.c" 3 4
        stderr
# 293 "genwqe_vpd_common.c"
        , "%s:%u: Error: " "Wrong VPD Version found %x\n", "genwqe_vpd_common.c", 293, swap.ui32); } while (0);
         parse_error = 
# 294 "genwqe_vpd_common.c" 3 4
                      1
# 294 "genwqe_vpd_common.c"
                          ;
        }
       }
       if (get_crc_value) {
        ...
        get_crc_value = 
# 299 "genwqe_vpd_common.c" 3 4
                       0
# 299 "genwqe_vpd_common.c"
                            ;
        ...
        csv_crc.ui32 = 
# 304 "genwqe_vpd_common.c" 3 4
                      (__builtin_constant_p((__u32)((__u32)(__be32)(
# 304 "genwqe_vpd_common.c"
                      csv_crc.ui32
# 304 "genwqe_vpd_common.c" 3 4
                      ))) ? ((__u32)( (((__u32)((__u32)(__be32)(
# 304 "genwqe_vpd_common.c"
...
# 304 "genwqe_vpd_common.c"
  ...
  if (parse_error) {
   do { fprintf(
# 333 "genwqe_vpd_common.c" 3 4
  stderr
# 333 "genwqe_vpd_common.c"
  , "%s:%u: Error: " "Line# %d Field: %d Syndrom: <%s>\n",
                                   "genwqe_vpd_common.c"
# 333 "genwqe_vpd_common.c"
   ,
                                   334
# 333 "genwqe_vpd_common.c"
   , line_nr, field_num, token); } while (0)
                                    ;
   return (
# 335 "genwqe_vpd_common.c" 3 4
          0
# 335 "genwqe_vpd_common.c"
               );
  }
  if (num_fields < 4) {
   do { if (_dbg_flag) fprintf(
# 338 "genwqe_vpd_common.c" 3 4
  stdout
# 338 "genwqe_vpd_common.c"
  , "Skip Line# %d\n", line_nr); } while(0);
   continue;
  } else {

   do { if (_dbg_flag) fprintf(
# 342 "genwqe_vpd_common.c" 3 4
  stdout
# 342 "genwqe_vpd_common.c"
  , "Line# %d OK Num Fields %d Offset: %d Size: %d\n", line_nr, num_fields, seek_offset, write_size); } while(0)
                                                       ;
   memcpy(&buffer[seek_offset], data, write_size);
   seek_offset += write_size;
   crc32 = genwqe_crc32_gen(data, write_size, crc32);
   if (seek_offset > (64*1024)) {
    do { fprintf(
# 348 "genwqe_vpd_common.c" 3 4
   stderr
# 348 "genwqe_vpd_common.c"
   , "%s:%u: Error: " "Exit due to out of buffer size %d\n",
                      "genwqe_vpd_common.c"
# 348 "genwqe_vpd_common.c"
    ,
                      349
# 348 "genwqe_vpd_common.c"
    , seek_offset); } while (0)
                       ;
    parse_error = 
# 350 "genwqe_vpd_common.c" 3 4
                 1
# 350 "genwqe_vpd_common.c"
                     ;
    break;
   }
  }
 ...
 *crc32_from_csv = csv_crc.ui32;
 ...
 if ((parse_error) || ((sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) != good_lines))
  return (
# 363 "genwqe_vpd_common.c" 3 4
         0
# 363 "genwqe_vpd_common.c"
              );
 return (
# 364 "genwqe_vpd_common.c" 3 4
        1
# 364 "genwqe_vpd_common.c"
            );
}
