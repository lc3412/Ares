...
static unsigned int infl_ndefl = 1;
...
# 121 "zlib_mt_perf.c" 3 4
_Bool 
# 121 "zlib_mt_perf.c"
     first_run;

 unsigned int comp_calls;
 unsigned int decomp_calls;
 unsigned long defl_total;
 unsigned long defl_time;
 unsigned long infl_total;
 unsigned long infl_time;
...
static int pin_to_cpu(int run_cpu)
{
 ...
 num_cpus = 
# 146 "zlib_mt_perf.c" 3 4
           1024
# 146 "zlib_mt_perf.c"
                      ;
 cpusetp = 
# 147 "zlib_mt_perf.c" 3 4
          __sched_cpualloc (
# 147 "zlib_mt_perf.c"
          num_cpus
# 147 "zlib_mt_perf.c" 3 4
...
static inline void *__malloc(size_t size)
{
 ...
 rc = posix_memalign(&ptr, sysconf(
# 182 "zlib_mt_perf.c" 3 4
                                  _SC_PAGESIZE
# 182 "zlib_mt_perf.c"
                                              ), size);
 if (rc != 0) {
  fprintf(
# 184 "zlib_mt_perf.c" 3 4
         stderr
# 184 "zlib_mt_perf.c"
               , "err: errno=%d %s\n", 
# 184 "zlib_mt_perf.c" 3 4
...
static int defl(struct thread_data *d, FILE *source, int level)
{
 ...
 in = __malloc(CHUNK_i);
 if (in == 
# 217 "zlib_mt_perf.c" 3 4
          ((void *)0)
# 217 "zlib_mt_perf.c"
              )
  return 
# 218 "zlib_mt_perf.c" 3
        (-1)
# 218 "zlib_mt_perf.c"
               ;
 ...
 if (out == 
# 221 "zlib_mt_perf.c" 3 4
           ((void *)0)
# 221 "zlib_mt_perf.c"
               ) {
  __free(in);
  return 
# 223 "zlib_mt_perf.c" 3
        (-1)
# 223 "zlib_mt_perf.c"
               ;
 }
 ...
 strm.zalloc = 
# 227 "zlib_mt_perf.c" 3
              0
# 227 "zlib_mt_perf.c"
                    ;
 strm.zfree = 
# 228 "zlib_mt_perf.c" 3
             0
# 228 "zlib_mt_perf.c"
                   ;
 strm.opaque = 
# 229 "zlib_mt_perf.c" 3
              0
# 229 "zlib_mt_perf.c"
                    ;

 ret = 
# 231 "zlib_mt_perf.c" 3
      deflateInit2_((
# 231 "zlib_mt_perf.c"
      &strm
# 231 "zlib_mt_perf.c" 3
...
# 233 "zlib_mt_perf.c"
 ...
 do {
  ...
  if (ferror(source)) {
   ...
   __free(out);
   return 
# 246 "zlib_mt_perf.c" 3
         (-1)
# 246 "zlib_mt_perf.c"
                ;
  }
  flush = feof(source) ? 
# 248 "zlib_mt_perf.c" 3
                        4 
# 248 "zlib_mt_perf.c"
                                 : 
# 248 "zlib_mt_perf.c" 3
...
# 262 "zlib_mt_perf.c" 3 4
  ((
# 262 "zlib_mt_perf.c"
  ret != 
# 262 "zlib_mt_perf.c" 3
  (-2)) ? (void) (0) : __assert_fail (
# 262 "zlib_mt_perf.c"
  "ret != Z_STREAM_ERROR"
# 262 "zlib_mt_perf.c" 3 4
  , "zlib_mt_perf.c", 262, __PRETTY_FUNCTION__))
# 262 "zlib_mt_perf.c"
                               ;
# 274 "zlib_mt_perf.c"
  } while (strm.avail_out == 0);
  
# 275 "zlib_mt_perf.c" 3 4
 ((
# 275 "zlib_mt_perf.c"
 strm.avail_in == 0
# 275 "zlib_mt_perf.c" 3 4
...
# 275 "zlib_mt_perf.c"
 "strm.avail_in == 0"
# 275 "zlib_mt_perf.c" 3 4
 , "zlib_mt_perf.c", 275, __PRETTY_FUNCTION__))
# 275 "zlib_mt_perf.c"
                           ;


 } while (flush != 
# 278 "zlib_mt_perf.c" 3
                  4
# 278 "zlib_mt_perf.c"
                          );
 
# 279 "zlib_mt_perf.c" 3 4
((
# 279 "zlib_mt_perf.c"
ret == 
# 279 "zlib_mt_perf.c" 3
1) ? (void) (0) : __assert_fail (
# 279 "zlib_mt_perf.c"
"ret == Z_STREAM_END"
# 279 "zlib_mt_perf.c" 3 4
, "zlib_mt_perf.c", 279, __PRETTY_FUNCTION__))
# 279 "zlib_mt_perf.c"
                           ;
...
# 284 "zlib_mt_perf.c"
 ...
 if (d->first_run) {
  ...
  d->first_run = 
# 287 "zlib_mt_perf.c" 3 4
                0
# 287 "zlib_mt_perf.c"
                     ;
 } else if (strm.adler != d->checksum) {
  fprintf(
# 289 "zlib_mt_perf.c" 3 4
         stderr
# 289 "zlib_mt_perf.c"
               , "Err: checksum mismatch %08lx != %08x\n",
   strm.adler, d->checksum);
  ret = 
# 291 "zlib_mt_perf.c" 3
       (-2)
# 291 "zlib_mt_perf.c"
                     ;
 }
...
static int infl(struct thread_data *d, FILE *source)
{
 ...
 in = __malloc(CHUNK_i);
 if (in == 
# 320 "zlib_mt_perf.c" 3 4
          ((void *)0)
# 320 "zlib_mt_perf.c"
              )
  return 
# 321 "zlib_mt_perf.c" 3
        (-1)
# 321 "zlib_mt_perf.c"
               ;
 ...
 out = __malloc(CHUNK_o);
 if (out == 
# 324 "zlib_mt_perf.c" 3 4
           ((void *)0)
# 324 "zlib_mt_perf.c"
               ) {
  __free(in);
  return 
# 326 "zlib_mt_perf.c" 3
        (-1)
# 326 "zlib_mt_perf.c"
               ;
 }
 ...
 strm.zalloc = 
# 330 "zlib_mt_perf.c" 3
              0
# 330 "zlib_mt_perf.c"
                    ;
 strm.zfree = 
# 331 "zlib_mt_perf.c" 3
             0
# 331 "zlib_mt_perf.c"
                   ;
 strm.opaque = 
# 332 "zlib_mt_perf.c" 3
              0
# 332 "zlib_mt_perf.c"
                    ;
 strm.avail_in = 0;
 strm.next_in = 
# 334 "zlib_mt_perf.c" 3
               0
# 334 "zlib_mt_perf.c"
                     ;

 ret = 
# 336 "zlib_mt_perf.c" 3
      inflateInit2_((
# 336 "zlib_mt_perf.c"
      &strm
# 336 "zlib_mt_perf.c" 3
...
# 369 "zlib_mt_perf.c"
    ...
    __free(out);
    return 
# 373 "zlib_mt_perf.c" 3
          (-3)
# 373 "zlib_mt_perf.c"
                      ;
   case 
# 374 "zlib_mt_perf.c" 3
       (-2)
# 374 "zlib_mt_perf.c"
                     :
   case 
# 375 "zlib_mt_perf.c" 3
       (-3)
# 375 "zlib_mt_perf.c"
                   :
   case 
# 376 "zlib_mt_perf.c" 3
       (-4)
# 376 "zlib_mt_perf.c"
                  :
    (void)inflateEnd(&strm);
...
# 396 "zlib_mt_perf.c"
 ...
 if (d->first_run) {
  d->checksum = strm.adler;
  d->first_run = 
# 403 "zlib_mt_perf.c" 3 4
                0
# 403 "zlib_mt_perf.c"
                     ;
 } else if (strm.adler != d->checksum) {
  fprintf(
# 405 "zlib_mt_perf.c" 3 4
         stderr
# 405 "zlib_mt_perf.c"
               , "Err: checksum mismatch %08lx != %08x\n",
   strm.adler, d->checksum);
  ret = 
# 407 "zlib_mt_perf.c" 3
       (-2)
# 407 "zlib_mt_perf.c"
                     ;
 }
...
# 420 "zlib_mt_perf.c"
 ...
 switch (ret) {
 case 
# 423 "zlib_mt_perf.c" 3
     (-1)
# 423 "zlib_mt_perf.c"
            :
  fprintf(
# 424 "zlib_mt_perf.c" 3 4
         stderr
# 424 "zlib_mt_perf.c"
               , "errno=%d: %s\n", xerrno, strerror(xerrno));
  if (ferror(
# 425 "zlib_mt_perf.c" 3 4
            stdin
# 425 "zlib_mt_perf.c"
                 ))
   fputs("error reading stdin\n", 
# 426 "zlib_mt_perf.c" 3 4
                                 stderr
# 426 "zlib_mt_perf.c"
                                       );
  if (ferror(
# 427 "zlib_mt_perf.c" 3 4
            stdout
# 427 "zlib_mt_perf.c"
                  ))
   fputs("error writing stdout\n", 
# 428 "zlib_mt_perf.c" 3 4
                                  stderr
# 428 "zlib_mt_perf.c"
                                        );
  break;
 case 
# 430 "zlib_mt_perf.c" 3
     (-2)
# 430 "zlib_mt_perf.c"
                   :
  fputs("stream error\n", 
# 431 "zlib_mt_perf.c" 3 4
                         stderr
# 431 "zlib_mt_perf.c"
                               );
  break;
 case 
# 433 "zlib_mt_perf.c" 3
     (-3)
# 433 "zlib_mt_perf.c"
                 :
  fprintf(
# 434 "zlib_mt_perf.c" 3 4
         stderr
# 434 "zlib_mt_perf.c"
               , "invalid or incomplete deflate data (%d)\n",
   ret);
  break;
 case 
# 437 "zlib_mt_perf.c" 3
     (-4)
# 437 "zlib_mt_perf.c"
                :
  fputs("out of memory\n", 
# 438 "zlib_mt_perf.c" 3 4
                          stderr
# 438 "zlib_mt_perf.c"
                                );
  break;
 case 
# 440 "zlib_mt_perf.c" 3
     (-6)
# 440 "zlib_mt_perf.c"
                    :
  fputs("zlib version mismatch!\n", 
# 441 "zlib_mt_perf.c" 3 4
                                   stderr
# 441 "zlib_mt_perf.c"
                                         );
 }
...
# 497 "zlib_mt_perf.c"
 ...
 if (i_fp == 
# 501 "zlib_mt_perf.c" 3 4
            ((void *)0)
# 501 "zlib_mt_perf.c"
                ) {
  fprintf(
# 502 "zlib_mt_perf.c" 3 4
         stderr
# 502 "zlib_mt_perf.c"
               , "ERROR: Can't open file %s\n",i_fname);
  exit(
# 503 "zlib_mt_perf.c" 3 4
      1
# 503 "zlib_mt_perf.c"
                  );
 }
 ...
 for (i = 0; (i < count) && (exit_on_err == 0); i++) {
  rc = defl(d, i_fp, 
# 507 "zlib_mt_perf.c" 3
                    (-1)
# 507 "zlib_mt_perf.c"
                                         );
  if (rc != 
# 508 "zlib_mt_perf.c" 3
           0
# 508 "zlib_mt_perf.c"
               ) {
   fprintf(
# 509 "zlib_mt_perf.c" 3 4
          stderr
# 509 "zlib_mt_perf.c"
                , "err/def: rc=%d %s\n", rc, i_fname);
   zerr(rc);
...
static void *libz_thread_infl(void *data)
{
 ...
 d->cpu = sched_getcpu();
 d->first_run = 
# 538 "zlib_mt_perf.c" 3 4
               1
# 538 "zlib_mt_perf.c"
                   ;
 d->checksum = 0;

 do { if ((verbose) >= (1)) fprintf(
# 541 "zlib_mt_perf.c" 3 4
stderr
# 541 "zlib_mt_perf.c"
, "   Thread %d using cpu %d\n",d->tid, d->cpu); } while (0);

 c_fp = fopen(c_fname, "r");
 if (c_fp == 
# 544 "zlib_mt_perf.c" 3 4
            ((void *)0)
# 544 "zlib_mt_perf.c"
                ) {
  fprintf(
# 545 "zlib_mt_perf.c" 3 4
         stderr
# 545 "zlib_mt_perf.c"
               , "Error: Can't open file %s\n",c_fname);
  exit(
# 546 "zlib_mt_perf.c" 3 4
      1
# 546 "zlib_mt_perf.c"
                  );
 }
 ...
 for (i = 0; (i < count) && (exit_on_err == 0); i++) {
  rc = infl(d, c_fp);
  if (rc != 
# 551 "zlib_mt_perf.c" 3
           0
# 551 "zlib_mt_perf.c"
               ) {
   fprintf(
# 552 "zlib_mt_perf.c" 3 4
          stderr
# 552 "zlib_mt_perf.c"
                , "%08x.%08x err/inf: rc=%d %s\n",
...
static int run_threads(struct thread_data *d, unsigned int threads)
{
 ...
 for (i = 0; i < threads; i++) {
  ...
  if (infl_ndefl == 1) {
   rc = pthread_create(&d[i].thread_id, 
# 586 "zlib_mt_perf.c" 3 4
                                       ((void *)0)
# 586 "zlib_mt_perf.c"
                                           ,
...
# 589 "zlib_mt_perf.c"
  ...
  if (rc != 0) {
   fprintf(
# 593 "zlib_mt_perf.c" 3 4
          stderr
# 593 "zlib_mt_perf.c"
                ,
    "starting %d. libz_thread failed!\n", i);
   return 
# 595 "zlib_mt_perf.c" 3 4
         1
# 595 "zlib_mt_perf.c"
                     ;
  }
 ...
 for (i = 0; i < threads; i++) {
  rc = pthread_join(d[i].thread_id, 
# 600 "zlib_mt_perf.c" 3 4
                                   ((void *)0)
# 600 "zlib_mt_perf.c"
                                       );
  if (rc != 0) {
   fprintf(
# 602 "zlib_mt_perf.c" 3 4
          stderr
# 602 "zlib_mt_perf.c"
                ,
    "joining threads failed!\n");
   return 
# 604 "zlib_mt_perf.c" 3 4
         1
# 604 "zlib_mt_perf.c"
                     ;
  }
        ...
        unsigned int threads)
{
 ...
 if (print_hdr)
  do { if ((verbose) >= (0)) fprintf(
# 621 "zlib_mt_perf.c" 3 4
 stderr
# 621 "zlib_mt_perf.c"
 ...
 for (i = 0; i < threads; i++) {
  do { if ((verbose) >= (1)) fprintf(
# 626 "zlib_mt_perf.c" 3 4
 stderr
# 626 "zlib_mt_perf.c"
 , "%6d ; %6ld ; %3d ; " "%6d ; %10ld ; %10ld     ; %11.3f     ; %08x ;\n", i, (unsigned long)d[i].tid, (int)d[i].thread_rc, d[i].comp_calls, d[i].defl_total, d[i].defl_time / 1000, d[i].defl_time ? d[i].defl_total*1000 / (double)d[i].defl_time : 0.0, d[i].checksum); } while (0)
 ...
 do { if ((verbose) >= (0)) fprintf(
# 643 "zlib_mt_perf.c" 3 4
stderr
# 643 "zlib_mt_perf.c"
, "%6d ;    all ;     ; " "%6d ; %10ld ; %10ld     ; %11.3f    ; %08x ; " "%d/%d\n", i, comp_calls, defl_total, time_ns_threads / 1000, time_ns_threads ? defl_total * 1000/(double)time_ns_threads : 0.0, d[0].checksum, CHUNK_i/1024, CHUNK_o/1024); } while (0)
...
# 665 "zlib_mt_perf.c"
 ...
 for (i = 0; i < threads; i++) {
  do { if ((verbose) >= (1)) fprintf(
# 670 "zlib_mt_perf.c" 3 4
 stderr
# 670 "zlib_mt_perf.c"
 , "%6d ; %6ld ; %3d ; " "%6d ; %10ld ; %10ld     ; %11.3f     ; %08x ;\n", i, (unsigned long)d[i].tid, (int)d[i].thread_rc, d[i].decomp_calls, d[i].infl_total, d[i].infl_time / 1000, d[i].infl_time ? d[i].infl_total * 1000 / (double)d[i].infl_time : 0.0, d[i].checksum); } while (0)
 ...
 do { if ((verbose) >= (0)) fprintf(
# 687 "zlib_mt_perf.c" 3 4
stderr
# 687 "zlib_mt_perf.c"
, "%6d ;    all ;     ; " "%6d ; %10ld ; %10ld     ; %11.3f    ; %08x ; " "%d/%d\n", i, decomp_calls, infl_total, time_ns_threads / 1000, time_ns_threads ? infl_total * 1000 / (double)time_ns_threads : 0.0, d[0].checksum, CHUNK_i/1024, CHUNK_o/1024); } while (0)
...
# 770 "zlib_mt_perf.c"
  ...
  case 'V':
   fprintf(
# 773 "zlib_mt_perf.c" 3 4
          stdout
# 773 "zlib_mt_perf.c"
                , "%s\n", version);
   exit(
# 774 "zlib_mt_perf.c" 3 4
       0
# 774 "zlib_mt_perf.c"
                   );
   break;
...
# 779 "zlib_mt_perf.c"
 ...
 if (d == 
# 785 "zlib_mt_perf.c" 3 4
         ((void *)0)
# 785 "zlib_mt_perf.c"
             )
  return 
# 786 "zlib_mt_perf.c" 3 4
        1
# 786 "zlib_mt_perf.c"
                    ;
 ...
 rc = pthread_mutex_init(&mutex, 
# 790 "zlib_mt_perf.c" 3 4
                                ((void *)0)
# 790 "zlib_mt_perf.c"
                                    );
 if (rc != 0)
  fprintf(
# 792 "zlib_mt_perf.c" 3 4
         stderr
# 792 "zlib_mt_perf.c"
               , "err: initializing mutex failed!\n");
