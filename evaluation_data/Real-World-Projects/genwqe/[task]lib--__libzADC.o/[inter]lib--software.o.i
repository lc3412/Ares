      ...
      const char *version, int stream_size)
{
 ...
 do { if ((p_deflateInit2_) == 
# 74 "software.c" 3 4
((void *)0)
# 74 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 74,"p_deflateInit2_"); } while (0); return (
# 74 "software.c" 3
(-2)
# 74 "software.c"
); } } while (0);
...
int z_deflateParams(z_streamp strm, int level, int strategy)
{
 do { if ((p_deflateParams) == 
# 83 "software.c" 3 4
((void *)0)
# 83 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 83,"p_deflateParams"); } while (0); return (
# 83 "software.c" 3
(-2)
# 83 "software.c"
); } } while (0);
...
uLong z_deflateBound(z_streamp strm, uLong sourceLen)
{
 do { if ((p_deflateBound) == 
# 90 "software.c" 3 4
((void *)0)
# 90 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 90,"p_deflateBound"); } while (0); return (
# 90 "software.c" 3
(-2)
# 90 "software.c"
); } } while (0);
...
int z_deflateReset(z_streamp strm)
{
 do { if ((p_deflateReset) == 
# 97 "software.c" 3 4
((void *)0)
# 97 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 97,"p_deflateReset"); } while (0); return (
# 97 "software.c" 3
(-2)
# 97 "software.c"
); } } while (0);
...
int z_deflateSetDictionary(z_streamp strm, const Bytef *dictionary,
      uInt dictLength)
{
 do { if ((p_deflateSetDictionary) == 
# 106 "software.c" 3 4
((void *)0)
# 106 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 106,"p_deflateSetDictionary"); } while (0); return (
# 106 "software.c" 3
(-2)
# 106 "software.c"
); } } while (0);
...
int z_deflateSetHeader(z_streamp strm, gz_headerp head)
{
 do { if ((p_deflateSetHeader) == 
# 113 "software.c" 3 4
((void *)0)
# 113 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 113,"p_deflateSetHeader"); } while (0); return (
# 113 "software.c" 3
(-2)
# 113 "software.c"
); } } while (0);
...
int z_deflatePrime(z_streamp strm, int bits, int value)
{
 do { if ((p_deflatePrime) == 
# 121 "software.c" 3 4
((void *)0)
# 121 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 121,"p_deflatePrime"); } while (0); return (
# 121 "software.c" 3
(-2)
# 121 "software.c"
); } } while (0);
...
((void *)0)
# 128 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 128,"p_deflateCopy"); } while (0); return (
# 128 "software.c" 3
(-2)
# 128 "software.c"
); } } while (0);
...
((void *)0)
# 135 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 135,"p_deflate"); } while (0); return (
# 135 "software.c" 3
(-2)
# 135 "software.c"
); } } while (0);
...
((void *)0)
# 142 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 142,"p_deflateEnd"); } while (0); return (
# 142 "software.c" 3
(-2)
# 142 "software.c"
); } } while (0);
      ...
      int stream_size)
{
 ...
 do { if ((p_inflateInit2_) == 
# 153 "software.c" 3 4
((void *)0)
# 153 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 153,"p_inflateInit2_"); } while (0); return (
# 153 "software.c" 3
(-2)
# 153 "software.c"
); } } while (0);
...
int z_inflateReset(z_streamp strm)
{
 do { if ((p_inflateReset) == 
# 161 "software.c" 3 4
((void *)0)
# 161 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 161,"p_inflateReset"); } while (0); return (
# 161 "software.c" 3
(-2)
# 161 "software.c"
); } } while (0);
...
int z_inflateReset2(z_streamp strm, int windowBits)
{
 do { if ((p_inflateReset2) == 
# 168 "software.c" 3 4
((void *)0)
# 168 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 168,"p_inflateReset2"); } while (0); return (
# 168 "software.c" 3
(-2)
# 168 "software.c"
); } } while (0);
...
int z_inflateSetDictionary(z_streamp strm, const Bytef *dictionary,
      uInt dictLength)
{
 do { if ((p_inflateSetDictionary) == 
# 177 "software.c" 3 4
((void *)0)
# 177 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 177,"p_inflateSetDictionary"); } while (0); return (
# 177 "software.c" 3
(-2)
# 177 "software.c"
); } } while (0);
...
int z_inflateGetHeader(z_streamp strm, gz_headerp head)
{
 do { if ((p_inflateGetHeader) == 
# 203 "software.c" 3 4
((void *)0)
# 203 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 203,"p_inflateGetHeader"); } while (0); return (
# 203 "software.c" 3
(-2)
# 203 "software.c"
); } } while (0);
...
int z_inflatePrime(z_streamp strm, int bits, int value)
{
 do { if ((p_inflatePrime) == 
# 210 "software.c" 3 4
((void *)0)
# 210 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 210,"p_inflatePrime"); } while (0); return (
# 210 "software.c" 3
(-2)
# 210 "software.c"
); } } while (0);
...
((void *)0)
# 217 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 217,"p_inflateSync"); } while (0); return (
# 217 "software.c" 3
(-2)
# 217 "software.c"
); } } while (0);
...
((void *)0)
# 224 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 224,"p_inflate"); } while (0); return (
# 224 "software.c" 3
(-2)
# 224 "software.c"
); } } while (0);
...
((void *)0)
# 231 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 231,"p_inflateEnd"); } while (0); return (
# 231 "software.c" 3
(-2)
# 231 "software.c"
); } } while (0);
...
int z_inflateBackInit_(z_streamp strm, int windowBits,
         ...
         int stream_size)
{
 do { if ((p_inflateBackInit_) == 
# 242 "software.c" 3 4
((void *)0)
# 242 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 242,"p_inflateBackInit_"); } while (0); return (
# 242 "software.c" 3
(-2)
# 242 "software.c"
); } } while (0);
...
((void *)0)
# 252 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 252,"p_inflateBack"); } while (0); return (
# 252 "software.c" 3
(-2)
# 252 "software.c"
); } } while (0);
...
int z_inflateBackEnd(z_streamp strm)
{
 do { if ((p_inflateBackEnd) == 
# 259 "software.c" 3 4
((void *)0)
# 259 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 259,"p_inflateBackEnd"); } while (0); return (
# 259 "software.c" 3
(-2)
# 259 "software.c"
); } } while (0);
...
((void *)0)
# 266 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 266,"p_adler32"); } while (0); return (
# 266 "software.c" 3
(-2)
# 266 "software.c"
); } } while (0);
...
static uLong (* p_adler32_combine)(uLong adler1, uLong adler2, 
# 270 "software.c" 3
                                                              off_t 
# 270 "software.c"
                                                                      len2);
...
# 271 "software.c"
                                                           len2)
{
 do { if ((p_adler32_combine) == 
# 273 "software.c" 3 4
((void *)0)
# 273 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 273,"p_adler32_combine"); } while (0); return (
# 273 "software.c" 3
(-2)
# 273 "software.c"
); } } while (0);
...
((void *)0)
# 280 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 280,"p_crc32"); } while (0); return (
# 280 "software.c" 3
(-2)
# 280 "software.c"
); } } while (0);
...
static uLong (* p_crc32_combine)(uLong crc1, uLong crc2, 
# 284 "software.c" 3
                                                        off_t 
# 284 "software.c"
                                                                len2);
...
# 285 "software.c"
                                                     len2)
{
 do { if ((p_crc32_combine) == 
# 287 "software.c" 3 4
((void *)0)
# 287 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 287,"p_crc32_combine"); } while (0); return (
# 287 "software.c" 3
(-2)
# 287 "software.c"
); } } while (0);
...
((void *)0)
# 294 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 294,"p_zError"); } while (0); return (
# 294 "software.c" 3 4
((void *)0)
# 294 "software.c"
); } } while (0);
...
((void *)0)
# 307 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 307,"p_zlibVersion"); } while (0); return (
# 307 "software.c" 3 4
((void *)0)
# 307 "software.c"
); } } while (0);
...
((void *)0)
# 315 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 315,"p_gzopen"); } while (0); return (
# 315 "software.c" 3 4
((void *)0)
# 315 "software.c"
); } } while (0);
...
((void *)0)
# 323 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 323,"p_gzdopen"); } while (0); return (
# 323 "software.c" 3 4
((void *)0)
# 323 "software.c"
); } } while (0);
...
((void *)0)
# 332 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 332,"p_gzwrite"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 340 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 340,"p_gzread"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 348 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 348,"p_gzclose"); } while (0); return (
# 348 "software.c" 3
(-2)
# 348 "software.c"
); } } while (0);
...
((void *)0)
# 356 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 356,"p_gzungetc"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 364 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 364,"p_gzflush"); } while (0); return (
# 364 "software.c" 3
(-2)
# 364 "software.c"
); } } while (0);
...
((void *)0)
# 372 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 372,"p_gzeof"); } while (0); return (0); } } while (0);
 return (* p_gzeof)(file);
}
...
((void *)0)
# 380 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 380,"p_gztell"); } while (0); return (-1ll); } } while (0);
...
((void *)0)
# 388 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 388,"p_gzerror"); } while (0); return (
# 388 "software.c" 3 4
((void *)0)
# 388 "software.c"
); } } while (0);
...
((void *)0)
# 396 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 396,"p_gzseek"); } while (0); return (-1ll); } } while (0);
...
((void *)0)
# 404 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 404,"p_gzrewind"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 412 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 412,"p_gzgets"); } while (0); return (
# 412 "software.c" 3 4
((void *)0)
# 412 "software.c"
); } } while (0);
...
((void *)0)
# 420 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 420,"p_gzputc"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 430 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 430,"p_gzgetc"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 438 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 438,"p_gzputs"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 449 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 449,"p_gzprintf"); } while (0); return (-1); } } while (0);
...
((void *)0)
# 464 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 464,"p_compress"); } while (0); return (
# 464 "software.c" 3
(-2)
# 464 "software.c"
); } } while (0);
...
((void *)0)
# 474 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 474,"p_compress2"); } while (0); return (
# 474 "software.c" 3
(-2)
# 474 "software.c"
); } } while (0);
...
uLong z_compressBound(uLong sourceLen)
{
 do { if ((p_compressBound) == 
# 481 "software.c" 3 4
((void *)0)
# 481 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 481,"p_compressBound"); } while (0); return (
# 481 "software.c" 3
(-2)
# 481 "software.c"
); } } while (0);
...
((void *)0)
# 491 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 491,"p_uncompress"); } while (0); return (
# 491 "software.c" 3
(-2)
# 491 "software.c"
); } } while (0);
...
((void *)0)
# 500 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 500,"p_gzbuffer"); } while (0); return (-1); } } while (0);
...
# 505 "software.c"
                  len2);
uLong adler32_combine64(uLong adler1, uLong adler2, 
# 506 "software.c" 3
                                                   off64_t 
# 506 "software.c"
                                                             len2)
{
 ...
 do { if ((p_adler32_combine64) == 
# 509 "software.c" 3 4
((void *)0)
# 509 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 509,"p_adler32_combine64"); } while (0); return (
# 509 "software.c" 3
(-2)
# 509 "software.c"
); } } while (0);
...
static uLong (* p_crc32_combine64)(uLong crc1, uLong crc2, 
# 513 "software.c" 3
                                                          off64_t 
# 513 "software.c"
                                                                    len2);
uLong crc32_combine64(uLong crc1, uLong crc2, 
# 514 "software.c" 3
                                             off64_t 
# 514 "software.c"
                                                       len2)
{
 ...
 do { if ((p_crc32_combine64) == 
# 517 "software.c" 3 4
((void *)0)
# 517 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 517,"p_crc32_combine64"); } while (0); return (
# 517 "software.c" 3
(-2)
# 517 "software.c"
); } } while (0);
...
((void *)0)
# 525 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 525,"p_gzopen64"); } while (0); return (
# 525 "software.c" 3 4
((void *)0)
# 525 "software.c"
); } } while (0);
...
((void *)0)
# 533 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 533,"p_gztell64"); } while (0); return (-1ll); } } while (0);
...
((void *)0)
# 541 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 541,"p_gzseek64"); } while (0); return (-1ll); } } while (0);
...
((void *)0)
# 549 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 549,"p_gzoffset"); } while (0); return (-1ll); } } while (0);
...
((void *)0)
# 557 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 557,"p_gzoffset64"); } while (0); return (-1ll); } } while (0);
...
const z_crc_t *get_crc_table()
{
 ...
 do { if ((p_get_crc_table) == 
# 565 "software.c" 3 4
((void *)0)
# 565 "software.c"
) { do { fprintf(zlib_log, "%s:%u: Error: " "%s not loadable, consider using a " "newer libz version.\n", "software.c", 565,"p_get_crc_table"); } while (0); return (
# 565 "software.c" 3 4
((void *)0)
# 565 "software.c"
); } } while (0);
...
void zedc_sw_init(void)
{
 char *error;
# 621 "software.c"
 if (strcmp("/usr/local/lib/libz.so.1", "") == 0) {
  do { fprintf(zlib_log, "%s:%u: Error: " "  Empty CONFIG_ZLIB_PATH \"%s\"\n",
                         "software.c"
# 622 "software.c"
  ,
                         623
# 622 "software.c"
  , "/usr/local/lib/libz.so.1"); } while (0)
                          ;
  return;
 }


 do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "Loading software zlib \"%s\"\n", "/usr/local/lib/libz.so.1"); } while (0);
 dlerror();
 handle = dlopen("/usr/local/lib/libz.so.1", 
# 630 "software.c" 3 4
                                  0x00001
# 630 "software.c"
                                           );
...
# 631 "software.c"
  ...
  do { fprintf(zlib_log, "%s:%u: Error: " "  %s\n", "software.c", 632, dlerror()); } while (0);
  return;
 }
 ...
 do { dlerror(); *(pvoid_t *)(&p_zlibVersion) = dlsym(handle, "zlibVersion"); if ((error = dlerror()) != 
# 639 "software.c" 3 4
((void *)0)
# 639 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "  ZLIB_VERSION=%s (header) zlibVersion()=%s (code)\n", 
# 641 "software.c" 3
"1.2.11"
# 641 "software.c"
, z_zlibVersion()); } while (0)
                                 ;
...
# 644 "software.c"
                       , z_zlibVersion()) != 0) {
  do { fprintf(zlib_log, "%s:%u: Error: " "libz.so.1=%s and zlib.h=%s do not match!\n",
                                      "software.c"
# 645 "software.c"
  ,
                                      646
...
# 645 "software.c"
 ...
 do { dlerror(); *(pvoid_t *)(&p_deflateInit2_) = dlsym(handle, "deflateInit2_"); if ((error = dlerror()) != 
# 650 "software.c" 3 4
((void *)0)
# 650 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateParams) = dlsym(handle, "deflateParams"); if ((error = dlerror()) != 
# 651 "software.c" 3 4
((void *)0)
# 651 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateBound) = dlsym(handle, "deflateBound"); if ((error = dlerror()) != 
# 652 "software.c" 3 4
((void *)0)
# 652 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateReset) = dlsym(handle, "deflateReset"); if ((error = dlerror()) != 
# 653 "software.c" 3 4
((void *)0)
# 653 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflatePrime) = dlsym(handle, "deflatePrime"); if ((error = dlerror()) != 
# 654 "software.c" 3 4
((void *)0)
# 654 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateCopy) = dlsym(handle, "deflateCopy"); if ((error = dlerror()) != 
# 655 "software.c" 3 4
((void *)0)
# 655 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflate) = dlsym(handle, "deflate"); if ((error = dlerror()) != 
# 656 "software.c" 3 4
((void *)0)
# 656 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateSetDictionary) = dlsym(handle, "deflateSetDictionary"); if ((error = dlerror()) != 
# 657 "software.c" 3 4
((void *)0)
# 657 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateSetHeader) = dlsym(handle, "deflateSetHeader"); if ((error = dlerror()) != 
# 658 "software.c" 3 4
((void *)0)
# 658 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_deflateEnd) = dlsym(handle, "deflateEnd"); if ((error = dlerror()) != 
# 659 "software.c" 3 4
((void *)0)
# 659 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { dlerror(); *(pvoid_t *)(&p_inflateInit2_) = dlsym(handle, "inflateInit2_"); if ((error = dlerror()) != 
# 661 "software.c" 3 4
((void *)0)
# 661 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateSync) = dlsym(handle, "inflateSync"); if ((error = dlerror()) != 
# 662 "software.c" 3 4
((void *)0)
# 662 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflatePrime) = dlsym(handle, "inflatePrime"); if ((error = dlerror()) != 
# 663 "software.c" 3 4
((void *)0)
# 663 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflate) = dlsym(handle, "inflate"); if ((error = dlerror()) != 
# 664 "software.c" 3 4
((void *)0)
# 664 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateReset) = dlsym(handle, "inflateReset"); if ((error = dlerror()) != 
# 665 "software.c" 3 4
((void *)0)
# 665 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateReset2) = dlsym(handle, "inflateReset2"); if ((error = dlerror()) != 
# 666 "software.c" 3 4
((void *)0)
# 666 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateSetDictionary) = dlsym(handle, "inflateSetDictionary"); if ((error = dlerror()) != 
# 667 "software.c" 3 4
((void *)0)
# 667 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateGetDictionary) = dlsym(handle, "inflateGetDictionary"); if ((error = dlerror()) != 
# 668 "software.c" 3 4
((void *)0)
# 668 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateGetHeader) = dlsym(handle, "inflateGetHeader"); if ((error = dlerror()) != 
# 669 "software.c" 3 4
((void *)0)
# 669 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateEnd) = dlsym(handle, "inflateEnd"); if ((error = dlerror()) != 
# 670 "software.c" 3 4
((void *)0)
# 670 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { dlerror(); *(pvoid_t *)(&p_inflateBackInit_) = dlsym(handle, "inflateBackInit_"); if ((error = dlerror()) != 
# 672 "software.c" 3 4
((void *)0)
# 672 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateBack) = dlsym(handle, "inflateBack"); if ((error = dlerror()) != 
# 673 "software.c" 3 4
((void *)0)
# 673 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_inflateBackEnd) = dlsym(handle, "inflateBackEnd"); if ((error = dlerror()) != 
# 674 "software.c" 3 4
((void *)0)
# 674 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { dlerror(); *(pvoid_t *)(&p_gzopen) = dlsym(handle, "gzopen"); if ((error = dlerror()) != 
# 676 "software.c" 3 4
((void *)0)
# 676 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzdopen) = dlsym(handle, "gzdopen"); if ((error = dlerror()) != 
# 677 "software.c" 3 4
((void *)0)
# 677 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzwrite) = dlsym(handle, "gzwrite"); if ((error = dlerror()) != 
# 678 "software.c" 3 4
((void *)0)
# 678 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzread) = dlsym(handle, "gzread"); if ((error = dlerror()) != 
# 679 "software.c" 3 4
((void *)0)
# 679 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzclose) = dlsym(handle, "gzclose"); if ((error = dlerror()) != 
# 680 "software.c" 3 4
((void *)0)
# 680 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzflush) = dlsym(handle, "gzflush"); if ((error = dlerror()) != 
# 681 "software.c" 3 4
((void *)0)
# 681 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzungetc) = dlsym(handle, "gzungetc"); if ((error = dlerror()) != 
# 682 "software.c" 3 4
((void *)0)
# 682 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzeof) = dlsym(handle, "gzeof"); if ((error = dlerror()) != 
# 683 "software.c" 3 4
((void *)0)
# 683 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gztell) = dlsym(handle, "gztell"); if ((error = dlerror()) != 
# 684 "software.c" 3 4
((void *)0)
# 684 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzerror) = dlsym(handle, "gzerror"); if ((error = dlerror()) != 
# 685 "software.c" 3 4
((void *)0)
# 685 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzseek) = dlsym(handle, "gzseek"); if ((error = dlerror()) != 
# 686 "software.c" 3 4
((void *)0)
# 686 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzrewind) = dlsym(handle, "gzrewind"); if ((error = dlerror()) != 
# 687 "software.c" 3 4
((void *)0)
# 687 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzputs) = dlsym(handle, "gzputs"); if ((error = dlerror()) != 
# 688 "software.c" 3 4
((void *)0)
# 688 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzputc) = dlsym(handle, "gzputc"); if ((error = dlerror()) != 
# 689 "software.c" 3 4
((void *)0)
# 689 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzgetc) = dlsym(handle, "gzgetc"); if ((error = dlerror()) != 
# 690 "software.c" 3 4
((void *)0)
# 690 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
...
# 691 "software.c"
 ...
 do { dlerror(); *(pvoid_t *)(&p_gzprintf) = dlsym(handle, "gzprintf"); if ((error = dlerror()) != 
# 692 "software.c" 3 4
((void *)0)
# 692 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { dlerror(); *(pvoid_t *)(&p_compress) = dlsym(handle, "compress"); if ((error = dlerror()) != 
# 694 "software.c" 3 4
((void *)0)
# 694 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_compress2) = dlsym(handle, "compress2"); if ((error = dlerror()) != 
# 695 "software.c" 3 4
((void *)0)
# 695 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_compressBound) = dlsym(handle, "compressBound"); if ((error = dlerror()) != 
# 696 "software.c" 3 4
((void *)0)
# 696 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_uncompress) = dlsym(handle, "uncompress"); if ((error = dlerror()) != 
# 697 "software.c" 3 4
((void *)0)
# 697 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { dlerror(); *(pvoid_t *)(&p_zError) = dlsym(handle, "zError"); if ((error = dlerror()) != 
# 699 "software.c" 3 4
((void *)0)
# 699 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_zlibCompileFlags) = dlsym(handle, "zlibCompileFlags"); if ((error = dlerror()) != 
# 700 "software.c" 3 4
((void *)0)
# 700 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);

 do { dlerror(); *(pvoid_t *)(&p_adler32) = dlsym(handle, "adler32"); if ((error = dlerror()) != 
# 702 "software.c" 3 4
((void *)0)
# 702 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_adler32_combine) = dlsym(handle, "adler32_combine"); if ((error = dlerror()) != 
# 703 "software.c" 3 4
((void *)0)
# 703 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_crc32) = dlsym(handle, "crc32"); if ((error = dlerror()) != 
# 704 "software.c" 3 4
((void *)0)
# 704 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_crc32_combine) = dlsym(handle, "crc32_combine"); if ((error = dlerror()) != 
# 705 "software.c" 3 4
((void *)0)
# 705 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 ...
 do { dlerror(); *(pvoid_t *)(&p_gzbuffer) = dlsym(handle, "gzbuffer"); if ((error = dlerror()) != 
# 709 "software.c" 3 4
((void *)0)
# 709 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzopen64) = dlsym(handle, "gzopen64"); if ((error = dlerror()) != 
# 710 "software.c" 3 4
((void *)0)
# 710 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzseek64) = dlsym(handle, "gzseek64"); if ((error = dlerror()) != 
# 711 "software.c" 3 4
((void *)0)
# 711 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gztell64) = dlsym(handle, "gztell64"); if ((error = dlerror()) != 
# 712 "software.c" 3 4
((void *)0)
# 712 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzoffset) = dlsym(handle, "gzoffset"); if ((error = dlerror()) != 
# 713 "software.c" 3 4
((void *)0)
# 713 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_gzoffset64) = dlsym(handle, "gzoffset64"); if ((error = dlerror()) != 
# 714 "software.c" 3 4
((void *)0)
# 714 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_adler32_combine64) = dlsym(handle, "adler32_combine64"); if ((error = dlerror()) != 
# 715 "software.c" 3 4
((void *)0)
# 715 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_crc32_combine64) = dlsym(handle, "crc32_combine64"); if ((error = dlerror()) != 
# 716 "software.c" 3 4
((void *)0)
# 716 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
 do { dlerror(); *(pvoid_t *)(&p_get_crc_table) = dlsym(handle, "get_crc_table"); if ((error = dlerror()) != 
# 717 "software.c" 3 4
((void *)0)
# 717 "software.c"
) { do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "%s\n", error); } while (0); } } while (0);
...
# 723 "software.c"
  ...
  do { if ((zlib_trace & 0x4)) fprintf(zlib_log, "sss " "Closing software zlib\n"); } while (0);
  dlclose(handle);
 }
}
