...
# 74 "genwqe_vpdconv.c"
                                    , 'h' },
     { "crcoff", 
# 75 "genwqe_vpdconv.c" 3 4
                 0
# 75 "genwqe_vpdconv.c"
                            , &make_crc, 0 },
     { "reverse", 
# 76 "genwqe_vpdconv.c" 3 4
                 0
# 76 "genwqe_vpdconv.c"
                            , &reverse_mode, 1 },
     { 0, 
# 77 "genwqe_vpdconv.c" 3 4
          0
# 77 "genwqe_vpdconv.c"
                     , 
# 77 "genwqe_vpdconv.c" 3 4
...
int main(int argc, char *argv[])
{
    int option;
    char *input_file = 
# 86 "genwqe_vpdconv.c" 3 4
                      ((void *)0)
# 86 "genwqe_vpdconv.c"
                          ;
    char *output_file = 
# 87 "genwqe_vpdconv.c" 3 4
                       ((void *)0)
# 87 "genwqe_vpdconv.c"
                           ;
    FILE *ip = 
# 88 "genwqe_vpdconv.c" 3 4
              ((void *)0)
# 88 "genwqe_vpdconv.c"
                  , *op = 
# 88 "genwqe_vpdconv.c" 3 4
...
# 88 "genwqe_vpdconv.c"
                              ;
    uint8_t *buffer = 
# 89 "genwqe_vpdconv.c" 3 4
                     ((void *)0)
# 89 "genwqe_vpdconv.c"
                         ;
    uint32_t crc32, crc32_from_csv;
    int size, rc = 
# 91 "genwqe_vpdconv.c" 3 4
                  0
# 91 "genwqe_vpdconv.c"
                              ;
 ...
 if (
# 100 "genwqe_vpdconv.c" 3 4
    (-1) 
# 100 "genwqe_vpdconv.c"
        == option)
     break;
 ...
 case 'i':
     if (
# 108 "genwqe_vpdconv.c" 3 4
        ((void *)0) 
# 108 "genwqe_vpdconv.c"
             != optarg)
  input_file = optarg;
     else {
  usage(argv[0]);
  exit(
# 112 "genwqe_vpdconv.c" 3 4
      1
# 112 "genwqe_vpdconv.c"
                  );
     }
     break;
 case 'o':
     if (
# 116 "genwqe_vpdconv.c" 3 4
        ((void *)0) 
# 116 "genwqe_vpdconv.c"
             != optarg)
  output_file = optarg;
     else {
  usage(argv[0]);
  exit(
# 120 "genwqe_vpdconv.c" 3 4
      1
# 120 "genwqe_vpdconv.c"
                  );
     }
     break;
 case 'h':
     usage(argv[0]);
     exit(
# 125 "genwqe_vpdconv.c" 3 4
         0
# 125 "genwqe_vpdconv.c"
                     );
     break;
 case 'V':
     fprintf(
# 128 "genwqe_vpdconv.c" 3 4
            stdout
# 128 "genwqe_vpdconv.c"
                  , "%s\n", version);
     exit(
# 129 "genwqe_vpdconv.c" 3 4
         0
# 129 "genwqe_vpdconv.c"
                     );
     break;
 case 'v':
     verbose_flag++;
 ...
 default:
     usage(argv[0]);
     exit(
# 138 "genwqe_vpdconv.c" 3 4
         1
# 138 "genwqe_vpdconv.c"
                     );
     break;
 }
    }
 ...
 if (optind < argc) {
     ...
     if (optind < argc) {
  do { fprintf(
# 148 "genwqe_vpdconv.c" 3 4
 stderr
# 148 "genwqe_vpdconv.c"
 , "%s:%u: Error: " "Too many args\n", "genwqe_vpdconv.c", 148); } while (0);
  exit(
# 149 "genwqe_vpdconv.c" 3 4
      1
# 149 "genwqe_vpdconv.c"
                  );
     }
 }
    }
...
# 154 "genwqe_vpdconv.c" 3 4
stdout
# 154 "genwqe_vpdconv.c"
, "Input File:   <%s>\n", input_file); } while(0);
 ip = fopen(input_file, "r");
 if (
# 156 "genwqe_vpdconv.c" 3 4
    ((void *)0) 
# 156 "genwqe_vpdconv.c"
         == ip) {
     do { fprintf(
# 157 "genwqe_vpdconv.c" 3 4
    stderr
# 157 "genwqe_vpdconv.c"
    , "%s:%u: Error: " "%s Open: <%s>\n", "genwqe_vpdconv.c", 157, strerror(
# 157 "genwqe_vpdconv.c" 3 4
    (*__errno_location ())
# 157 "genwqe_vpdconv.c"
    ), input_file); } while (0);
     exit (
# 158 "genwqe_vpdconv.c" 3 4
          1
# 158 "genwqe_vpdconv.c"
                      );
 }
    }
    if (output_file) {
 do { if (_dbg_flag) fprintf(
# 162 "genwqe_vpdconv.c" 3 4
stdout
# 162 "genwqe_vpdconv.c"
, "Output File:  <%s>\n", output_file); } while(0);
 op = fopen(output_file, "w");
 if (
# 164 "genwqe_vpdconv.c" 3 4
    ((void *)0) 
# 164 "genwqe_vpdconv.c"
         == op) {
     do { fprintf(
# 165 "genwqe_vpdconv.c" 3 4
    stderr
# 165 "genwqe_vpdconv.c"
    , "%s:%u: Error: " "%s Open: <%s>\n", "genwqe_vpdconv.c", 165, strerror(
# 165 "genwqe_vpdconv.c" 3 4
    (*__errno_location ())
# 165 "genwqe_vpdconv.c"
    ), output_file); } while (0);
     if (ip) fclose(ip);
     exit (
# 167 "genwqe_vpdconv.c" 3 4
          1
# 167 "genwqe_vpdconv.c"
                      );
 }
    }
    ...
    if (
# 172 "genwqe_vpdconv.c" 3 4
       ((void *)0) 
# 172 "genwqe_vpdconv.c"
            == ip) {
 do { if (_dbg_flag) fprintf(
# 173 "genwqe_vpdconv.c" 3 4
stdout
# 173 "genwqe_vpdconv.c"
, "Read from stdin\n"); } while(0);
 ip = 
# 174 "genwqe_vpdconv.c" 3 4
     stdin
# 174 "genwqe_vpdconv.c"
          ;
    }

    if (
# 177 "genwqe_vpdconv.c" 3 4
       ((void *)0) 
# 177 "genwqe_vpdconv.c"
            == op) {
 do { if (_dbg_flag) fprintf(
# 178 "genwqe_vpdconv.c" 3 4
stdout
# 178 "genwqe_vpdconv.c"
, "Write to stdout\n"); } while(0);
 op = 
# 179 "genwqe_vpdconv.c" 3 4
     stdout
# 179 "genwqe_vpdconv.c"
           ;
    }
 ...
 if (1 == reverse_mode) {
     file_size = fread(buffer, 1, (64*1024), ip);
     do { if (_dbg_flag) fprintf(
# 187 "genwqe_vpdconv.c" 3 4
    stdout
# 187 "genwqe_vpdconv.c"
    , "Bin file now in buffer = %d\n", (int)file_size); } while(0);
     if ((2*(sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) + (sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) + (sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) + 2+7+7+7+13+5+4+6+6+4) != file_size) {
  do { fprintf(
# 189 "genwqe_vpdconv.c" 3 4
 stderr
# 189 "genwqe_vpdconv.c"
 , "%s:%u: Error: " "Your Binary input does have %d of %d Bytes\n",
                                   "genwqe_vpdconv.c"
# 189 "genwqe_vpdconv.c"
  ,
                                   190
# 189 "genwqe_vpdconv.c"
  , (int)file_size, (int)(2*(sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) + (sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) + (sizeof(vpd_ref_102)/sizeof(struct vpd_layout)) + 2+7+7+7+13+5+4+6+6+4)); } while (0)
                                    ;
     } else bin_2_csv(op, file_size, buffer);
 } else {
     if (csv_2_bin(ip, buffer, &size, &crc32, &crc32_from_csv)) {
  if ((0 != crc32) && (1 == make_crc)) {
      crc32 = genwqe_crc32_gen(buffer, size-4, 0xffffffff);
      new_crc32.ui32 = 
# 196 "genwqe_vpdconv.c" 3 4
                      (__builtin_constant_p((__u32)((__u32)(__be32)(
# 196 "genwqe_vpdconv.c"
                      crc32
# 196 "genwqe_vpdconv.c" 3 4
...
# 201 "genwqe_vpdconv.c" 3 4
     stdout
# 201 "genwqe_vpdconv.c"
     , "Input CRC: 0x%x -> Good CRC: 0x%x added to Output.\n", crc32_from_csv, crc32); } while (0)
                         ;
  }
  fwrite(buffer, 1, size, op);
     } else {
  rc = 
# 206 "genwqe_vpdconv.c" 3 4
      1
# 206 "genwqe_vpdconv.c"
                  ;
     }
 }
 free(buffer);
 ...
 do { fprintf(
# 211 "genwqe_vpdconv.c" 3 4
stderr
# 211 "genwqe_vpdconv.c"
, "%s:%u: Error: " "Malloc(%d)\n", "genwqe_vpdconv.c", 211, (64*1024)); } while (0);
 rc = 
# 212 "genwqe_vpdconv.c" 3 4
     1
# 212 "genwqe_vpdconv.c"
                 ;
    }
    do { if (_dbg_flag) fprintf(
# 214 "genwqe_vpdconv.c" 3 4
   stdout
# 214 "genwqe_vpdconv.c"
   , "Close Input and Output.\n"); } while(0);
    fclose(ip);
    fclose(op);
    do { if (verbose_flag) fprintf(
# 217 "genwqe_vpdconv.c" 3 4
   stdout
# 217 "genwqe_vpdconv.c"
   , "Exit with rc: %d\n", rc); } while (0);
    exit(rc);
}
