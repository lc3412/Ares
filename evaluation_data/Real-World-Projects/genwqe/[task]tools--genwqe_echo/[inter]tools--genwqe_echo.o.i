...
# 116 "genwqe_echo.c" 3 4
 stdout
# 116 "genwqe_echo.c"
 , "test string too long (%u)\n", (unsigned int)strlen(tstring)); } while (0)
                                 ;
 ...
 do { if (verbose_flag) fprintf(
# 144 "genwqe_echo.c" 3 4
stdout
# 144 "genwqe_echo.c"
, "%u ECHO DDCBs prepared (%u bytes to send)\n", count, len); } while (0);
}
     ...
     char *teststring)
{
 ...
 if (cmd == 
# 159 "genwqe_echo.c" 3 4
           ((void *)0)
# 159 "genwqe_echo.c"
               ) {
  fprintf(
# 160 "genwqe_echo.c" 3 4
         stderr
# 160 "genwqe_echo.c"
               , "err: failed to alloc cmd memory\n");
  return -
# 161 "genwqe_echo.c" 3 4
         12
# 161 "genwqe_echo.c"
               ;
 }
 ...
 rc = accel_ddcb_execute(card, pcmd, 
# 170 "genwqe_echo.c" 3 4
                                    ((void *)0)
# 170 "genwqe_echo.c"
                                        , &xerrno);
 if (rc != 0) {
  fprintf(
# 172 "genwqe_echo.c" 3 4
         stderr
# 172 "genwqe_echo.c"
               ,
...
# 185 "genwqe_echo.c"
 ...
 for (j = 0; j < preload; j++) {
  if (strncmp((char *)pcmd->asv, teststring,
   ...
   do { if (verbose_flag) fprintf(
# 212 "genwqe_echo.c" 3 4
  stdout
# 212 "genwqe_echo.c"
  , "Echo OK (retc=%x %s)\n", pcmd->retc, ddcb_retc_strerror(pcmd->retc)); } while (0)
                                   ;
  }
  pcmd++;
 }
...
# 232 "genwqe_echo.c" 3 4
_Bool 
# 232 "genwqe_echo.c"
     print_hardware_version = 
# 232 "genwqe_echo.c" 3 4
                              0
# 232 "genwqe_echo.c"
                                   ;
 ...
 unsigned int mode = (0x0004 | 0x0008);
...
# 308 "genwqe_echo.c"
  ...
  case 'c':
   count = strtol(optarg, (char **)
# 312 "genwqe_echo.c" 3 4
                                  ((void *)0)
# 312 "genwqe_echo.c"
                                      , 0);
   run_infinite = 0;
   break;
  case 'l':
   preload = strtol(optarg, (char **)
# 316 "genwqe_echo.c" 3 4
                                    ((void *)0)
# 316 "genwqe_echo.c"
                                        , 0);
   break;
  case 'i':
   interval = strtol(optarg, (char **)
# 319 "genwqe_echo.c" 3 4
                                     ((void *)0)
# 319 "genwqe_echo.c"
                                         , 0);
   break;
  ...
  case 's':
   ...
   break;
  case 'e':
   exit_on_err = strtol(optarg, (char **)
# 335 "genwqe_echo.c" 3 4
                                        ((void *)0)
# 335 "genwqe_echo.c"
                                            , 0);
   break;
...
# 372 "genwqe_echo.c"
 ...
 if (card == 
# 381 "genwqe_echo.c" 3 4
            ((void *)0)
# 381 "genwqe_echo.c"
                ) {
  fprintf(
# 382 "genwqe_echo.c" 3 4
         stderr
# 382 "genwqe_echo.c"
               , "err: failed to open card %u type %u "
 ...
 if (print_hardware_version) {
  accel_dump_hardware_version(card, 
# 389 "genwqe_echo.c" 3 4
                                   stderr
# 389 "genwqe_echo.c"
                                         );
  goto close_card;
 ...
 do { if (verbose_flag) fprintf(
# 396 "genwqe_echo.c" 3 4
stdout
# 396 "genwqe_echo.c"
, "Start DDCB Echo '%s' for unit #%x\n", teststring, unit); } while (0);
 if (preload < 1)
  preload = 1;

 signal(
# 400 "genwqe_echo.c" 3 4
       2
# 400 "genwqe_echo.c"
             , INT_handler);
 ...
 while (!stop_echoing) {
  ...
  gettimeofday(&t0, 
# 409 "genwqe_echo.c" 3 4
                   ((void *)0)
# 409 "genwqe_echo.c"
                       );
  rc = do_echo(card, preload, unit, teststring);
  gettimeofday(&t1, 
# 411 "genwqe_echo.c" 3 4
                   ((void *)0)
# 411 "genwqe_echo.c"
                       );
  ...
  if (rc == 0) {
   if (!flood && !quiet) {
    printf("%d x %u bytes from UNIT #%x: "
           ...
           unit, ((double)(((&t1)->tv_sec * 1000000 + (&t1)->tv_usec) - ((&t0)->tv_sec * 1000000 + (&t0)->tv_usec))));
   }
   packets_received++;
  }
 ...
 if (rc != 0)
  exit(
# 458 "genwqe_echo.c" 3 4
      1
# 458 "genwqe_echo.c"
                  );

 exit(
# 460 "genwqe_echo.c" 3 4
     0
# 460 "genwqe_echo.c"
                 );
}
