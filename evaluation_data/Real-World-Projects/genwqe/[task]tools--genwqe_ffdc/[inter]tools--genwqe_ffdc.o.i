...
# 25 "../include/linux/uapi/linux/genwqe/genwqe_card.h"
...
# 26 "../include/linux/uapi/linux/genwqe/genwqe_card.h" 2
...
static inline uint64_t genwqe_readq(card_handle_t c, uint32_t reg)
{
 ...
 if (rc != 0)
  fprintf(
# 33 "genwqe_ffdc.c" 3 4
         stderr
# 33 "genwqe_ffdc.c"
               , "warn: genwqe_readq returned %d\n", rc);
...
static uint64_t vreadq(card_handle_t c, uint32_t reg, int func)
{
 ...
 rc = genwqe_card_write_reg64(c, 0x00060000, func & 0xf);
 if (rc != 0) {
  fprintf(
# 62 "genwqe_ffdc.c" 3 4
         stderr
# 62 "genwqe_ffdc.c"
               ,
   "warn: genwqe_card_write_reg64 returned %d errno=%d\n",
   rc, 
# 64 "genwqe_ffdc.c" 3 4
      (*__errno_location ())
# 64 "genwqe_ffdc.c"
           );
  return (uint64_t)-1;
...
# 83 "genwqe_ffdc.c" 3 4
stdout
# 83 "genwqe_ffdc.c"
, "[%s] Genwqe queue config and debug registers\n", __func__); } while (0);
 ...
 for (func = 0; func < 16; func++) {
  printf("PCI FUNCTION %d\n"
         ...
         0x00010010,
         (long long)vreadq(c, 0x00050010, func),
         0x00010100,
         (long long)vreadq(c, 0x00050100, func),
         0x00010000,
         (long long)vreadq(c, 0x00050000, func),
         0x00010020,
         (long long)vreadq(c, 0x00050020, func),
         0x00010028,
         (long long)vreadq(c, 0x00050028, func),
         0x00010008,
         (long long)vreadq(c, 0x00050008, func),
         0x00010030,
         (long long)vreadq(c, 0x00050030, func),
         0x00010038,
         (long long)vreadq(c, 0x00050038, func),
         0x00010040,
         (long long)vreadq(c, 0x00050040, func));
 }
}
...
# 177 "genwqe_ffdc.c"
 ...
 if (card == 
# 183 "genwqe_ffdc.c" 3 4
            ((void *)0)
# 183 "genwqe_ffdc.c"
                ) {
  do { fprintf(
# 184 "genwqe_ffdc.c" 3 4
 stderr
# 184 "genwqe_ffdc.c"
 , "%s:%u: Error: " "opening genwqe card (err=%d)\n", "genwqe_ffdc.c", 184, err_code); } while (0);
  exit(
# 185 "genwqe_ffdc.c" 3 4
      1
# 185 "genwqe_ffdc.c"
                  );
 }
