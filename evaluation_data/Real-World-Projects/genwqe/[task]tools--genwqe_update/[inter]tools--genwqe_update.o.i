...
static const struct genwqe_type card_types[] = {
 { .card_id = "GenWQE5-A7", .rbf_size = 33747356 },
 { .card_id = "GenWQE5-A4", .rbf_size = 26724840 },
 { .card_id = "GenWQE5-530", .rbf_size = 21465258 },
 { .card_id = "GenWQE4-230", .rbf_size = 11819684 },
 { .card_id = 
# 60 "genwqe_update.c" 3 4
             ((void *)0)
# 60 "genwqe_update.c"
                 , .rbf_size = 0 },
};
...
static size_t get_rbf_size(char *card_type)
{
 ...
 for (t = &card_types[0]; t->card_id != 
# 67 "genwqe_update.c" 3 4
                                       ((void *)0)
# 67 "genwqe_update.c"
                                           ; t++) {
...
static int read_card_type(int card_no)
{
 ...
 snprintf(sysfs, sizeof(sysfs), "/sys/class/" "genwqe" "/" "genwqe" "%d_card/type", card_no);
 sysfs_type[sizeof(sysfs)-1] = 0;

 fp = fopen(sysfs, "r");
 if (fp == 
# 89 "genwqe_update.c" 3 4
          ((void *)0)
# 89 "genwqe_update.c"
              )
  return -1;
 ...
 sysfs_type[strlen(sysfs_type)-1] = 0;
 fclose(fp);
 return 0;
}
# 111 "genwqe_update.c"
...
# 292 "genwqe_update.c"
  ...
  case 'p':
   ...
   break;
  case 'x':
   verify = strtol(optarg, (char **)
# 302 "genwqe_update.c" 3 4
                                   ((void *)0)
# 302 "genwqe_update.c"
                                       , 0);
   break;
...
# 325 "genwqe_update.c"
 ...
 if ((env) && (atoi(env) > 0)) {
  do { fprintf(
# 333 "genwqe_update.c" 3 4
 stderr
# 333 "genwqe_update.c"
 , "%s:%u: Error: " "driver / HW simulation active !\n", "genwqe_update.c", 333); } while (0);
  exit(
# 334 "genwqe_update.c" 3 4
      1
# 334 "genwqe_update.c"
                  );
 }
 ...
 if (upd.flength == 0)
  upd.flength = rbf_size;


 if (upd.fname == 
# 346 "genwqe_update.c" 3 4
                 ((void *)0)
# 346 "genwqe_update.c"
                     ) {
  do { fprintf(
# 347 "genwqe_update.c" 3 4
 stderr
# 347 "genwqe_update.c"
 , "%s:%u: Error: " "no input/output file!\n", "genwqe_update.c", 347); } while (0);
  exit(
# 348 "genwqe_update.c" 3 4
      66
# 348 "genwqe_update.c"
                );
 }
 ...
 if (!force && ((pext == 
# 352 "genwqe_update.c" 3 4
                        ((void *)0)
# 352 "genwqe_update.c"
                            ) || (strncmp(pext, ".rbf", 5) != 0))) {
  do { fprintf(
# 353 "genwqe_update.c" 3 4
 stderr
# 353 "genwqe_update.c"
 , "%s:%u: Error: " "'%s' is not an *.rbf file!\n", "genwqe_update.c", 353, upd.fname); } while (0);
  exit(
# 354 "genwqe_update.c" 3 4
      66
# 354 "genwqe_update.c"
                );
 }
 ...
 if (upd.partition != '0' && upd.partition != '1') {
  do { fprintf(
# 359 "genwqe_update.c" 3 4
 stderr
# 359 "genwqe_update.c"
 , "%s:%u: Error: " "partition '%c' invalid\n",
                                                     "genwqe_update.c"
# 359 "genwqe_update.c"
  ,
                                                     360
...
# 359 "genwqe_update.c"
 ? upd.partition : '?'); } while (0)
                                                      ;
  exit(
# 361 "genwqe_update.c" 3 4
      64
# 361 "genwqe_update.c"
              );
 }
 ...
 if (card == 
# 367 "genwqe_update.c" 3 4
            ((void *)0)
# 367 "genwqe_update.c"
                ) {
  do { fprintf(
# 368 "genwqe_update.c" 3 4
 stderr
# 368 "genwqe_update.c"
 , "%s:%u: Error: " "cannot open card %d! (err=%d)\n", "genwqe_update.c", 368, card_no, err_code); } while (0);
  exit(
# 369 "genwqe_update.c" 3 4
      1
# 369 "genwqe_update.c"
                  );
 }
 ...
 if (read_back) {
  if (upd.flength == 0) {
   do { fprintf(
# 375 "genwqe_update.c" 3 4
  stderr
# 375 "genwqe_update.c"
  , "%s:%u: Error: " "don't forget to specify a size!\n", "genwqe_update.c", 375); } while (0);
   rc = 
# 376 "genwqe_update.c" 3 4
       1
# 376 "genwqe_update.c"
                   ;
   goto __exit;
  ...
  if (rc < 0) {
   int xerrno = 
# 381 "genwqe_update.c" 3 4
               (*__errno_location ())
# 381 "genwqe_update.c"
                    ;

   do { fprintf(
# 383 "genwqe_update.c" 3 4
  stderr
# 383 "genwqe_update.c"
  , "%s:%u: Error: " "reading bitstream failed!\n" "  %s (errno=%d/%s)\n",
...
# 383 "genwqe_update.c"
   ,
                                                     ...
                                                     385
# 383 "genwqe_update.c"
   , card_strerror(rc), xerrno, strerror(xerrno)); } while (0)

                                                      ;
   print_move_flash_results(upd.retc, upd.attn,
       upd.progress);
   rc = 
# 388 "genwqe_update.c" 3 4
       1
# 388 "genwqe_update.c"
                   ;
   goto __exit;
  ...
  if (rc != 0) {
   do { fprintf(
# 396 "genwqe_update.c" 3 4
  stderr
# 396 "genwqe_update.c"
  , "%s:%u: Error: " "cannot find %s!\n", "genwqe_update.c", 396, upd.fname); } while (0);
   rc = 
# 397 "genwqe_update.c" 3 4
       1
# 397 "genwqe_update.c"
                   ;
   goto __exit;
  ...
  if (!force && (s.st_size != (ssize_t)upd.flength)) {
   do { fprintf(
# 402 "genwqe_update.c" 3 4
  stderr
# 402 "genwqe_update.c"
  , "%s:%u: Error: " "file size %d bytes does not match required " "size of bitstream %d bytes!\n",
...
# 402 "genwqe_update.c"
   ,
                                     ...
                                     404
# 402 "genwqe_update.c"
   , (int)s.st_size, upd.flength); } while (0)

                                      ;
   rc = 
# 405 "genwqe_update.c" 3 4
       1
# 405 "genwqe_update.c"
                   ;
   goto __exit;
  ...
  if (rc < 0) {
   int xerrno = 
# 411 "genwqe_update.c" 3 4
               (*__errno_location ())
# 411 "genwqe_update.c"
                    ;

   if (xerrno == 
# 413 "genwqe_update.c" 3 4
                28
# 413 "genwqe_update.c"
                      ) {
    do { if (verbose_flag) fprintf(
# 414 "genwqe_update.c" 3 4
   stdout
# 414 "genwqe_update.c"
   , "old bitstream with broken readback. " "Skipping verification.\n"); } while (0)
                                ;
    rc = 
# 416 "genwqe_update.c" 3 4
        0
# 416 "genwqe_update.c"
                    ;
    goto __exit;
