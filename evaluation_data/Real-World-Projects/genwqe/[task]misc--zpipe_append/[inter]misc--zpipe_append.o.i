...
static unsigned int CHUNK_i = 16 * 1024;
static unsigned int CHUNK_o = 16 * 1024;
static int _pattern = 0;

static inline pid_t gettid(void)
{
 return (pid_t)syscall(
# 66 "zpipe_append.c" 3 4
                      186
# 66 "zpipe_append.c"
                                );
}
        ...
        int level, size_t *compressed_size, size_t *uncompressed_size)
{
 ...
 in = malloc(CHUNK_i);
 if (in == 
# 99 "zpipe_append.c" 3 4
          ((void *)0)
# 99 "zpipe_append.c"
              )
  return 
# 100 "zpipe_append.c" 3
        (-1)
# 100 "zpipe_append.c"
               ;
 ...
 out = malloc(CHUNK_o);
 if (out == 
# 103 "zpipe_append.c" 3 4
           ((void *)0)
# 103 "zpipe_append.c"
               ) {
  free(in);
  return 
# 105 "zpipe_append.c" 3
        (-1)
# 105 "zpipe_append.c"
               ;
 }
 ...
 strm.zalloc = 
# 109 "zpipe_append.c" 3
              0
# 109 "zpipe_append.c"
                    ;
 strm.zfree = 
# 110 "zpipe_append.c" 3
             0
# 110 "zpipe_append.c"
                   ;
 strm.opaque = 
# 111 "zpipe_append.c" 3
              0
# 111 "zpipe_append.c"
                    ;
 strm.total_out = 0;
...
# 145 "zpipe_append.c" 3 4
  ((
# 145 "zpipe_append.c"
  ret != 
# 145 "zpipe_append.c" 3
  (-2)) ? (void) (0) : __assert_fail (
# 145 "zpipe_append.c"
  "ret != Z_STREAM_ERROR"
# 145 "zpipe_append.c" 3 4
  , "zpipe_append.c", 145, __PRETTY_FUNCTION__))
# 145 "zpipe_append.c"
                               ;
...
# 156 "zpipe_append.c"
 "strm.avail_in == 0"
# 156 "zpipe_append.c" 3 4
 , "zpipe_append.c", 156, __PRETTY_FUNCTION__))
# 156 "zpipe_append.c"
                           ;


 } while (flush != 
# 159 "zpipe_append.c" 3
                  4 
# 159 "zpipe_append.c"
                                              );
# 180 "zpipe_append.c"
 
# 180 "zpipe_append.c" 3 4
((
# 180 "zpipe_append.c"
ret == 
# 180 "zpipe_append.c" 3
1) ? (void) (0) : __assert_fail (
# 180 "zpipe_append.c"
"ret == Z_STREAM_END"
# 180 "zpipe_append.c" 3 4
, "zpipe_append.c", 180, __PRETTY_FUNCTION__))
# 180 "zpipe_append.c"
                           ;
        ...
        size_t *decompressed_bytes, int expect_z_stream_end)
{
 ...
 in = malloc(CHUNK_i);
 if (in == 
# 212 "zpipe_append.c" 3 4
          ((void *)0)
# 212 "zpipe_append.c"
              )
  return 
# 213 "zpipe_append.c" 3
        (-1)
# 213 "zpipe_append.c"
               ;
 ...
 out = malloc(CHUNK_o);
 if (out == 
# 216 "zpipe_append.c" 3 4
           ((void *)0)
# 216 "zpipe_append.c"
               ) {
  free(in);
  return 
# 218 "zpipe_append.c" 3
        (-1)
# 218 "zpipe_append.c"
               ;
 }
 ...
 strm.zalloc = 
# 225 "zpipe_append.c" 3
              0
# 225 "zpipe_append.c"
                    ;
 strm.zfree = 
# 226 "zpipe_append.c" 3
             0
# 226 "zpipe_append.c"
                   ;
 strm.opaque = 
# 227 "zpipe_append.c" 3
              0
# 227 "zpipe_append.c"
                    ;
 strm.avail_in = 0;
 strm.next_in = 
# 229 "zpipe_append.c" 3
               0
# 229 "zpipe_append.c"
                     ;
 strm.total_in = 0;
...
# 247 "zpipe_append.c"
  ...
  do {
   ...
   ret = inflate(&strm, _flush);




   if (expect_z_stream_end && (ret != 
# 264 "zpipe_append.c" 3
                                     1
# 264 "zpipe_append.c"
                                                 )) {
    fprintf(
# 265 "zpipe_append.c" 3 4
           stderr
# 265 "zpipe_append.c"
                 ,
   ...
   if (ret == 
# 273 "zpipe_append.c" 3
             (-2)
# 273 "zpipe_append.c"
                           ) {
    fprintf(
# 274 "zpipe_append.c" 3 4
           stderr
# 274 "zpipe_append.c"
                 ,
...
# 281 "zpipe_append.c"
    ...
    free(out);
    return 
# 285 "zpipe_append.c" 3
          (-3)
# 285 "zpipe_append.c"
                      ;
   case 
# 286 "zpipe_append.c" 3
       (-3)
# 286 "zpipe_append.c"
                   :
   case 
# 287 "zpipe_append.c" 3
       (-4)
# 287 "zpipe_append.c"
                  :
    (void)inflateEnd(&strm);
...
{
 fprintf(
# 323 "zpipe_append.c" 3 4
        stderr
# 323 "zpipe_append.c"
              , "zpipe_append (%d): ", ret);
 switch (ret) {
 case 
# 325 "zpipe_append.c" 3
     (-1)
# 325 "zpipe_append.c"
            :
  if (ferror(
# 326 "zpipe_append.c" 3 4
            stdin
# 326 "zpipe_append.c"
                 ))
   fputs("error reading stdin\n", 
# 327 "zpipe_append.c" 3 4
                                 stderr
# 327 "zpipe_append.c"
                                       );
  else if (ferror(
# 328 "zpipe_append.c" 3 4
                 stdout
# 328 "zpipe_append.c"
                       ))
   fputs("error writing stdout\n", 
# 329 "zpipe_append.c" 3 4
                                  stderr
# 329 "zpipe_append.c"
                                        );
  else
   fprintf(
# 331 "zpipe_append.c" 3 4
          stderr
# 331 "zpipe_append.c"
                , "errno=%d %s\n",
    
# 332 "zpipe_append.c" 3 4
   (*__errno_location ())
# 332 "zpipe_append.c"
        , strerror(
# 332 "zpipe_append.c" 3 4
...
# 332 "zpipe_append.c"
  ...
  break;
 case 
# 334 "zpipe_append.c" 3
     (-2)
# 334 "zpipe_append.c"
                   :
  fputs("invalid compression level\n", 
# 335 "zpipe_append.c" 3 4
                                      stderr
# 335 "zpipe_append.c"
                                            );
  break;
 case 
# 337 "zpipe_append.c" 3
     (-3)
# 337 "zpipe_append.c"
                 :
  fputs("invalid or incomplete deflate data\n", 
# 338 "zpipe_append.c" 3 4
                                               stderr
# 338 "zpipe_append.c"
                                                     );
  break;
 case 
# 340 "zpipe_append.c" 3
     (-4)
# 340 "zpipe_append.c"
                :
  fputs("out of memory\n", 
# 341 "zpipe_append.c" 3 4
                          stderr
# 341 "zpipe_append.c"
                                );
  break;
 case 
# 343 "zpipe_append.c" 3
     (-6)
# 343 "zpipe_append.c"
                    :
  fputs("zlib version mismatch!\n", 
# 344 "zpipe_append.c" 3 4
                                   stderr
# 344 "zpipe_append.c"
                                         );
  break;
...
{
 char *b = 
# 377 "zpipe_append.c" 3 4
          __xpg_basename
# 377 "zpipe_append.c"
                  (prog);

 fprintf(
# 379 "zpipe_append.c" 3 4
        stderr
# 379 "zpipe_append.c"
              , "%s usage: %s [-h] [-v]\n"
...
# 499 "zpipe_append.c"
 ...
 if (i_fp == 
# 507 "zpipe_append.c" 3 4
            ((void *)0)
# 507 "zpipe_append.c"
                )
  exit(
# 508 "zpipe_append.c" 3 4
      1
# 508 "zpipe_append.c"
                  );
 ...
 if (o_fp == 
# 511 "zpipe_append.c" 3 4
            ((void *)0)
# 511 "zpipe_append.c"
                )
  exit(
# 512 "zpipe_append.c" 3 4
      1
# 512 "zpipe_append.c"
                  );


 rc = def(i_fp, o_fp, window_bits, flush, 
# 515 "zpipe_append.c" 3
                                         (-1)
# 515 "zpipe_append.c"
                                                              ,
   &expected_bytes, &decompressed_bytes);
 if (rc != 
# 517 "zpipe_append.c" 3
          0
# 517 "zpipe_append.c"
              ) {
  fclose(o_fp);
...
# 520 "zpipe_append.c"
 ...
 o_fp = fopen(o_fname, "r");
 if (o_fp == 
# 533 "zpipe_append.c" 3 4
            ((void *)0)
# 533 "zpipe_append.c"
                )
  exit(
# 534 "zpipe_append.c" 3 4
      1
# 534 "zpipe_append.c"
                  );

 n_fp = fopen(n_fname, "w+");
 if (n_fp == 
# 537 "zpipe_append.c" 3 4
            ((void *)0)
# 537 "zpipe_append.c"
                )
  exit(
# 538 "zpipe_append.c" 3 4
      1
# 538 "zpipe_append.c"
                  );
# 551 "zpipe_append.c"
...
# 570 "zpipe_append.c"
 ...
 if (expected_bytes != decompressed_bytes) {
  fprintf(
# 573 "zpipe_append.c" 3 4
         stderr
# 573 "zpipe_append.c"
               , "err: compressed size mismatch "
...
# 585 "zpipe_append.c"
 ...
 if (rc != 0) {
  fprintf(
# 596 "zpipe_append.c" 3 4
         stderr
# 596 "zpipe_append.c"
               , "Input %s and output %s differ!\n",
   i_fname, n_fname);
  exit(
# 598 "zpipe_append.c" 3 4
      1
# 598 "zpipe_append.c"
                  );
 }
