         ...
         uint64_t mask)
{
 ...
 fd = open(res, 
# 108 "genwqe_poke.c" 3 4
               02
# 108 "genwqe_poke.c"
                     );
 if (fd < 0) {
  fprintf(
# 110 "genwqe_poke.c" 3 4
         stderr
# 110 "genwqe_poke.c"
               , "err: Can not open %s %s\n",
   res, strerror(
# 111 "genwqe_poke.c" 3 4
                (*__errno_location ())
# 111 "genwqe_poke.c"
                     ));
  exit(
# 112 "genwqe_poke.c" 3 4
      1
# 112 "genwqe_poke.c"
                  );
 }
...
# 117 "genwqe_poke.c" 3 4
       0x01
# 117 "genwqe_poke.c"
                 , fd, 0);
 if (memblk == 
# 118 "genwqe_poke.c" 3 4
              ((void *) -1)
# 118 "genwqe_poke.c"
                        ) {
  fprintf(
# 119 "genwqe_poke.c" 3 4
         stderr
# 119 "genwqe_poke.c"
               , "err: Can not mmap %s\n", res);
  exit(
# 120 "genwqe_poke.c" 3 4
      1
# 120 "genwqe_poke.c"
                  );
 }
...
# 130 "genwqe_poke.c"
                                            ;
   val64 = (val64 & ~mask) | (val & mask);
   *((uint32_t *)addr) = 
# 132 "genwqe_poke.c" 3 4
                        ((__be32)(__builtin_constant_p((__u32)((
# 132 "genwqe_poke.c"
                        val64
# 132 "genwqe_poke.c" 3 4
...
# 229 "genwqe_poke.c" 3 4
                          ((void *)0)
# 229 "genwqe_poke.c"
                              , 0);
   break;
  case 'p':
   psl_bar = strtol(optarg, (char **)
# 232 "genwqe_poke.c" 3 4
                                    ((void *)0)
# 232 "genwqe_poke.c"
                                        , 0);
   break;
  case 'm':
   mask = strtoll(optarg, (char **)
# 235 "genwqe_poke.c" 3 4
                                  ((void *)0)
# 235 "genwqe_poke.c"
                                      , 0);
   break;
...
# 263 "genwqe_poke.c"
 ...
 if (optind + 2 != argc) {
  usage(argv[0]);
  exit(
# 269 "genwqe_poke.c" 3 4
      1
# 269 "genwqe_poke.c"
                  );
 }

 offs = strtoull(argv[optind++], 
# 272 "genwqe_poke.c" 3 4
                                ((void *)0)
# 272 "genwqe_poke.c"
                                    , 0);
 val = strtoull(argv[optind++], 
# 273 "genwqe_poke.c" 3 4
                                ((void *)0)
# 273 "genwqe_poke.c"
                                    , 0);
 rbval = ~val;
 ...
 if ((card_no < 0) || (card_no > 4)) {
  fprintf(
# 289 "genwqe_poke.c" 3 4
         stderr
# 289 "genwqe_poke.c"
               , "err: (%d) is a invalid card number!\n",
   card_no);
  usage(argv[0]);
  exit(
# 292 "genwqe_poke.c" 3 4
      1
# 292 "genwqe_poke.c"
                  );
 }
 ...
 if (card == 
# 297 "genwqe_poke.c" 3 4
            ((void *)0)
# 297 "genwqe_poke.c"
                ) {
  fprintf(
# 298 "genwqe_poke.c" 3 4
         stderr
# 298 "genwqe_poke.c"
...
# 327 "genwqe_poke.c"
  ...
  if (rd_back) {
   if (rbrc != 0) {
    fprintf(
# 331 "genwqe_poke.c" 3 4
           stderr
# 331 "genwqe_poke.c"
                 , "err: read back failed\n");
    accel_close(card);
    exit(
# 333 "genwqe_poke.c" 3 4
        1
# 333 "genwqe_poke.c"
                    );
   }
   if (val != rbval) {
    fprintf(
# 336 "genwqe_poke.c" 3 4
           stderr
# 336 "genwqe_poke.c"
                 , "err: post verify failed\n");
    accel_close(card);
    exit(
# 338 "genwqe_poke.c" 3 4
        1
# 338 "genwqe_poke.c"
                    );
   }
