...
static uint64_t _card_get_frequency(void *card_data)
{
 ...
 slu_unitcfg = card_read_reg64(card_data, 0x00000000, 
# 107 "ddcb_card.c" 3 4
                                                         ((void *)0)
# 107 "ddcb_card.c"
                                                             );
 speed = (uint16_t)((slu_unitcfg >> 28) & 0x0full);
 if (speed >= (sizeof((speed_grade)) / sizeof((speed_grade)[0])))
  return 0;

 return speed_grade[speed] * (uint64_t)1000000;
}
...
# 120 "ddcb_card.c"
 ...
 app_unitcfg = card_read_reg64(card_data, 0x02000000, 
# 121 "ddcb_card.c" 3 4
                                                         ((void *)0)
# 121 "ddcb_card.c"
                                                             );
...
static uint64_t _card_get_queue_work_time(void *card_data)
{
 ...
 queue_wtime = card_read_reg64(card_data, 0x00010030, 
# 137 "ddcb_card.c" 3 4
                                                             ((void *)0)
# 137 "ddcb_card.c"
                                                                 );
