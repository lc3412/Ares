...
static struct ddcb_accel_funcs *accel_list = 
# 82 "libddcb.c" 3 4
                                            ((void *)0)
# 82 "libddcb.c"
                                                ;
...
static struct ddcb_accel_funcs *find_accelerator(int card_type)
{
 ...
 for (accel = accel_list; accel != 
# 98 "libddcb.c" 3 4
                                  ((void *)0)
# 98 "libddcb.c"
                                      ; accel = accel->priv_data) {
...
static const char * const retc_errlist[] = {
 [(((0x0000) < 0) ? -(0x0000) : (0x0000))] = "unexecuted/untouched DDCB",
 [(((0x0101) < 0) ? -(0x0101) : (0x0101))] = "pending execution",
 [(((0x0102) < 0) ? -(0x0102) : (0x0102))] = "command complete. no error",
 [(((0x0104) < 0) ? -(0x0104) : (0x0104))] =
 "application error, recoverable, please see ATTN and PROGR",
 [(((0x0108) < 0) ? -(0x0108) : (0x0108))] =
 "application error, non-recoverable, please see ATTN and PROGR",
 [(((0x01ff) < 0) ? -(0x01ff) : (0x01ff))] = "overwritten by driver",
 [(((0x0110) < 0) ? -(0x0110) : (0x0110))] = "unexecuted/removed from queue",
 [(((0x0120) < 0) ? -(0x0120) : (0x0120))] = "terminated",
};

static const int retc_nerr __attribute__((unused)) = (sizeof((retc_errlist)) / sizeof((retc_errlist)[0]));

const char *ddcb_retc_strerror(int errnum)
{
 if ((((errnum) < 0) ? -(errnum) : (errnum)) >= retc_nerr)
  return "unknown error code";
 return retc_errlist[(((errnum) < 0) ? -(errnum) : (errnum))];
}

static const char * const ddcb_errlist[] = {
 [(((-401) < 0) ? -(-401) : (-401))] = "libc call went wrong",
 [(((-402) < 0) ? -(-402) : (-402))] = "problems accessing accelerator",
 [(((-403) < 0) ? -(-403) : (-403))] = "cannot open accelerator",
 [(((-404) < 0) ? -(-404) : (-404))] = "library version mismatch",
 [(((-405) < 0) ? -(-405) : (-405))] = "illegal parameters",
 [(((-411) < 0) ? -(-411) : (-411))] = "ddcb execution failed",
 [(((-414) < 0) ? -(-414) : (-414))] ="application id wrong",
 [(((-415) < 0) ? -(-415) : (-415))] = "function not implemented",
 [(((-416) < 0) ? -(-416) : (-416))] = "out of memory",
 [(((-417) < 0) ? -(-417) : (-417))] = "entry not found",
 [(((-418) < 0) ? -(-418) : (-418))] = "timeout waiting on irq event",
 [(((-419) < 0) ? -(-419) : (-419))] = "failed waiting on expected event",
};

static const int ddcb_nerr __attribute__((unused)) = (sizeof((ddcb_errlist)) / sizeof((ddcb_errlist)[0]));

const char *ddcb_strerror(int errnum)
{
 if ((((errnum) < 0) ? -(errnum) : (errnum)) >= ddcb_nerr)
  return "unknown error code";
 return ddcb_errlist[(((errnum) < 0) ? -(errnum) : (errnum))];
}
...
# 425 "libddcb.c"
 ...
 if (accel->card_get_queue_work_time == 
# 428 "libddcb.c" 3 4
                                       ((void *)0)
# 428 "libddcb.c"
                                           )
...
# 451 "libddcb.c"
 ...
 if (accel->card_dump_hardware_version == 
# 454 "libddcb.c" 3 4
                                         ((void *)0)
# 454 "libddcb.c"
                                             )
...
# 530 "libddcb.c"
 ...
 if ((ddcb_trace & 0x0001)) {
  rc = pthread_mutex_init(&accel->slock, 
# 534 "libddcb.c" 3 4
                                        ((void *)0)
# 534 "libddcb.c"
                                            );
...
# 551 "libddcb.c"
  ...
  ddcb_trace = strtol(ddcb_trace_env, (char **)
# 552 "libddcb.c" 3 4
                                              ((void *)0)
# 552 "libddcb.c"
                                                  , 0);
