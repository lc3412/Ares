...
static unsigned long CHUNK_o = 8 * 1024;
...
# 181 "gzFile_test.c"
 ...
 if (!fp) {
  fprintf(
# 185 "gzFile_test.c" 3 4
         stderr
# 185 "gzFile_test.c"
               , "err: Cannot open file %s: %s\n",
   fname, strerror(
# 186 "gzFile_test.c" 3 4
                  (*__errno_location ())
# 186 "gzFile_test.c"
                       ));
  return -
# 187 "gzFile_test.c" 3 4
         19
# 187 "gzFile_test.c"
               ;
 }
 ...
 if (rc == -1) {
  fprintf(
# 191 "gzFile_test.c" 3 4
         stderr
# 191 "gzFile_test.c"
               , "err: Cannot read from %s: %s\n",
   fname, strerror(
# 192 "gzFile_test.c" 3 4
                  (*__errno_location ())
# 192 "gzFile_test.c"
                       ));
  fclose(fp);
  return -
# 194 "gzFile_test.c" 3 4
         5
# 194 "gzFile_test.c"
            ;
 }
...
# 208 "gzFile_test.c"
 ...
 if (!fp) {
  fprintf(
# 212 "gzFile_test.c" 3 4
         stderr
# 212 "gzFile_test.c"
               , "err: Cannot open file %s: %s\n",
   fname, strerror(
# 213 "gzFile_test.c" 3 4
                  (*__errno_location ())
# 213 "gzFile_test.c"
                       ));
  return -
# 214 "gzFile_test.c" 3 4
         19
# 214 "gzFile_test.c"
               ;
 }
 ...
 if (rc == -1) {
  fprintf(
# 218 "gzFile_test.c" 3 4
         stderr
# 218 "gzFile_test.c"
               , "err: Cannot write to %s: %s\n",
   fname, strerror(
# 219 "gzFile_test.c" 3 4
                  (*__errno_location ())
# 219 "gzFile_test.c"
                       ));
  fclose(fp);
  return -
# 221 "gzFile_test.c" 3 4
         5
# 221 "gzFile_test.c"
            ;
 }
         ...
         size_t chunk_o __attribute__((unused)), int level)
{
 ...
 ifp = fopen(i_fname, "r");
 if (ifp == 
# 240 "gzFile_test.c" 3 4
           ((void *)0)
# 240 "gzFile_test.c"
               ) {
  do { fprintf(
# 241 "gzFile_test.c" 3 4
 stderr
# 241 "gzFile_test.c"
 , "gzFile_test: " "Could not open %s, %s\n", i_fname, strerror(
# 241 "gzFile_test.c" 3 4
 (*__errno_location ())
# 241 "gzFile_test.c"
 )); } while (0);
 ...
 buf = malloc(chunk_i);
 if (
# 246 "gzFile_test.c" 3 4
    ((void *)0) 
# 246 "gzFile_test.c"
         == buf) {
  do { fprintf(
# 247 "gzFile_test.c" 3 4
 stderr
# 247 "gzFile_test.c"
 , "gzFile_test: " "%s\n", strerror(
# 247 "gzFile_test.c" 3 4
...
# 247 "gzFile_test.c"
 ...
 if (ofp == 
# 253 "gzFile_test.c" 3 4
           ((void *)0)
# 253 "gzFile_test.c"
               ) {
  do { fprintf(
# 254 "gzFile_test.c" 3 4
 stderr
# 254 "gzFile_test.c"
 , "gzFile_test: " "Could not open %s\n", o_fname); } while (0);
  goto err_buf;
 }
 ...
 if (rc != 0) {
  do { fprintf(
# 261 "gzFile_test.c" 3 4
 stderr
# 261 "gzFile_test.c"
 , "gzFile_test: " "Could not set gzFile buffer size %d\n", rc); } while (0);
  goto err_ofp;
 }
 ...
 do {
  ...
  if (ferror(ifp)) {
   do { fprintf(
# 269 "gzFile_test.c" 3 4
  stderr
# 269 "gzFile_test.c"
  , "gzFile_test: " "ferror %d\n", (int)len); } while (0);
   goto err_ofp;
  }
  rc = gzwrite(ofp, buf, len);
  if (rc == 0) {
   do { fprintf(
# 274 "gzFile_test.c" 3 4
  stderr
# 274 "gzFile_test.c"
  , "gzFile_test: " "gzwrite %d\n", rc); } while (0);
   goto err_ofp;
  }

  if (verbose == 1)
   do { fprintf(
# 279 "gzFile_test.c" 3 4
  stderr
# 279 "gzFile_test.c"
  , "  gztell64 returned %lld\n", (long long)gztell64(ofp)); } while (0)
                             ;
    ...
    off64_t offs, ssize_t size)
{
 ...
 ofp = fopen(o_fname, "w+");
 if (ofp == 
# 311 "gzFile_test.c" 3 4
           ((void *)0)
# 311 "gzFile_test.c"
               ) {
  do { fprintf(
# 312 "gzFile_test.c" 3 4
 stderr
# 312 "gzFile_test.c"
 , "gzFile_test: " "Could not open %s\n", o_fname); } while (0);
  return -1;
 ...
 buf = malloc(chunk_i);
 if (
# 317 "gzFile_test.c" 3 4
    ((void *)0) 
# 317 "gzFile_test.c"
         == buf) {
  do { fprintf(
# 318 "gzFile_test.c" 3 4
 stderr
# 318 "gzFile_test.c"
 , "gzFile_test: " "%s\n", strerror(
# 318 "gzFile_test.c" 3 4
...
# 318 "gzFile_test.c"
 ...
 if (ifp == 
# 323 "gzFile_test.c" 3 4
           ((void *)0)
# 323 "gzFile_test.c"
               ) {
  do { fprintf(
# 324 "gzFile_test.c" 3 4
 stderr
# 324 "gzFile_test.c"
 , "gzFile_test: " "Could not open %s\n", i_fname); } while (0);
  goto err_buf;
...
# 331 "gzFile_test.c"
 ...
 if (size != 0) {
  ...
  offs_rc = gzseek64(ifp, offs, 
# 341 "gzFile_test.c" 3 4
                               0
# 341 "gzFile_test.c"
                                       );
  if (offs_rc == offs) {
   do { fprintf(
# 343 "gzFile_test.c" 3 4
  stderr
# 343 "gzFile_test.c"
  , "gzFile_test: " "Could not seek %lld to desired offset %lld\n", (long long)offs_rc, (long long)offs); } while (0)
                                              ;
   goto err_ifp;
  }
 }
 ...
 do {
  ...
  if (len < 0) {
   do { fprintf(
# 352 "gzFile_test.c" 3 4
  stderr
# 352 "gzFile_test.c"
  , "gzFile_test: " "gzread error %d\n", (int)len); } while (0);
   goto err_ifp;
  }

  if (verbose == 1)
   do { fprintf(
# 357 "gzFile_test.c" 3 4
  stderr
# 357 "gzFile_test.c"
  , "  gztell64 returned %lld\n", (long long)gztell64(ifp)); } while (0)
                             ;

  if (verbose)
   do { fprintf(
# 361 "gzFile_test.c" 3 4
  stderr
# 361 "gzFile_test.c"
...
# 373 "gzFile_test.c"
  ...
  if (rc < 1) {
   do { fprintf(
# 377 "gzFile_test.c" 3 4
  stderr
# 377 "gzFile_test.c"
  , "gzFile_test: " "fwrite %d\n", rc); } while (0);
   goto err_ifp;
  }
  ...
  if (verbose)
   do { fprintf(
# 389 "gzFile_test.c" 3 4
  stderr
# 389 "gzFile_test.c"
  , "gzFile_test: " "len=%lld chunk_i=%lld\n", (long long)len, (long long)chunk_i); } while (0)
                                             ;

 } while (len <= (int)chunk_i);
...
# 395 "gzFile_test.c"
  ...
  do { fprintf(
# 396 "gzFile_test.c" 3 4
 stderr
# 396 "gzFile_test.c"
 , "gzFile_test: " "gzclose error %d\n", rc); } while (0);
  goto err_buf;
 }
 free(buf);
 fclose(ofp);
...
# 420 "gzFile_test.c"
 ...
 off64_t offs = 0;
 const char *i_fname = 
# 423 "gzFile_test.c" 3 4
                      ((void *)0)
# 423 "gzFile_test.c"
                          ;
 const char *o_fname = 
# 424 "gzFile_test.c" 3 4
                      ((void *)0)
# 424 "gzFile_test.c"
                          ;
 
# 425 "gzFile_test.c" 3 4
_Bool 
# 425 "gzFile_test.c"
     use_compress = 
# 425 "gzFile_test.c" 3 4
...
# 472 "gzFile_test.c" 3 4
                                    ((void *)0)
# 472 "gzFile_test.c"
                                        , 0);
   break;
  case 's':
   size = strtol(optarg, (char **)
# 475 "gzFile_test.c" 3 4
                                 ((void *)0)
# 475 "gzFile_test.c"
                                     , 0);
   break;
  case 'O':
   offs = strtol(optarg, (char **)
# 478 "gzFile_test.c" 3 4
                                 ((void *)0)
# 478 "gzFile_test.c"
                                     , 0);
   break;
...
# 508 "gzFile_test.c"
  ...
  case 'V':
   fprintf(
# 514 "gzFile_test.c" 3 4
          stdout
# 514 "gzFile_test.c"
                , "%s\n", version);
   exit(
# 515 "gzFile_test.c" 3 4
       0
# 515 "gzFile_test.c"
                   );
   break;
  ...
  case '?':
   usage(
# 525 "gzFile_test.c" 3 4
        stdout
# 525 "gzFile_test.c"
              , prog);
   exit(
# 526 "gzFile_test.c" 3 4
       0
# 526 "gzFile_test.c"
                   );
   break;
 ...
 if (optind < argc) {
  ...
  if (rc != 0) {
   do { fprintf(
# 540 "gzFile_test.c" 3 4
  stderr
# 540 "gzFile_test.c"
  , "gzFile_test: " "File %s does not exist!\n", i_fname); } while (0);
   exit(79);
  }
  if ((rc == 0) && 
# 543 "gzFile_test.c" 3 4
                  ((((
# 543 "gzFile_test.c"
                  s.st_mode
# 543 "gzFile_test.c" 3 4
...
# 543 "gzFile_test.c"
   ...
   do { fprintf(
# 544 "gzFile_test.c" 3 4
  stderr
# 544 "gzFile_test.c"
  , "gzFile_test: " "%s: Too many levels of symbolic links\n", i_fname); } while (0)
                  ;
   exit(
# 546 "gzFile_test.c" 3 4
       1
# 546 "gzFile_test.c"
                   );
  }
 ...
 if (optind < argc) {
  ...
  usage(
# 552 "gzFile_test.c" 3 4
       stderr
# 552 "gzFile_test.c"
             , prog);
  exit(
# 553 "gzFile_test.c" 3 4
      1
# 553 "gzFile_test.c"
                  );
 }
 if (optind != argc) {
  usage(
# 556 "gzFile_test.c" 3 4
       stderr
# 556 "gzFile_test.c"
             , prog);
  exit(
# 557 "gzFile_test.c" 3 4
      1
# 557 "gzFile_test.c"
                  );
 }
...
# 560 "gzFile_test.c"
  ...
  do { fprintf(
# 561 "gzFile_test.c" 3 4
 stderr
# 561 "gzFile_test.c"
 , "gzFile_test: " "No input or output file name provided."); } while (0);
  return -1;
        }

 fprintf(
# 565 "gzFile_test.c" 3 4
        stderr
# 565 "gzFile_test.c"
              , "%sCompress %s to %s in %ld bytes, "
