; ModuleID = './[inter]src--.libs--snprintf.o.i'
source_filename = "./[inter]src--.libs--snprintf.o.i"
...
!1 = !DIFile(filename: "[inter]src--.libs--snprintf.o.i", directory: "/home/lichi/Desktop/matio/[lib]src--.libs--libmatio.so.9.1.0")
!2 = !{}
